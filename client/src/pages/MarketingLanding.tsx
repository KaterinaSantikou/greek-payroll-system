...
export default function MarketingLanding({ locale: initialLocale = 'en' }: LandingPageProps) {
  ...
  return (
    <div className="min-h-screen bg-white">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-100 rounded-2xl p-8">
              <div className="bg-white rounded-lg shadow-lg p-6">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-lg font-semibold">PayrollSync Dashboard</h3>
      ...
      <section className="py-20 px-6 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">{t.security.title}</h2>
        </div>
...
const translations = {
  en: {
    hero: {
      ...
      subline: "Automated taxes & forms, ERGANI II and Digital Work Card compliance, instant SEPA payouts."
    },
    cta: {
      primary: "Start free",
    ...
    compliance: {
      items: ["ERGANI II", "Digital Work Card", "ΑΠΔ/ΦΜΥ", "SEPA Alerts", "e-EFKA"]
    },
    features: {
      ...
      cards: [
        {
          ...
          description: "Greek taxes, social security, and all government filings handled automatically."
        },
        {
          title: "Hours flow into payroll",
          description: "PTO, holidays, and timesheets sync directly from your time tracking system."
        },
        {
          title: "Employee self-service",
          description: "Employees view pay stubs, update details, and request time off themselves."
        },
        {
          title: "Works with your apps",
          description: "Integrates with QuickBooks, Xero, and popular time tracking tools."
        }
      ]
    },
    howItWorks: {
      title: "How it works",
      steps: [
        { title: "Connect company & time", description: "Link your business and time tracking" },
        { title: "Review hours & exceptions", description: "Check timesheets and handle any issues" },
        { title: "Run payroll", description: "Auto-calculate taxes and forms" },
        { title: "Pay & File", description: "SEPA payments and ΑΠΔ/ΦΜΥ filing" }
      ]
    },
    social: {
      ...
      testimonials: [
        {
          quote: "Payroll went from 6 hours to 15 minutes. Zero errors with ERGANI filings.",
          name: "Maria Kouris",
          role: "HR Director, Aegean Hotels"
        },
        {
          quote: "The Greek compliance automation saves us €2,000 monthly in accounting fees.",
          name: "Dimitris Stavros",
          role: "CFO, Mykonos Restaurants"
        },
        {
          quote: "Our employees love the self-service portal. No more payroll questions!",
          name: "Elena Papadaki", 
  ...
  el: {
    hero: {
      ...
      subline: "Αυτόματοι φόροι & έντυπα, συμμόρφωση με ΕΡΓΑΝΗ ΙΙ και Ψηφιακή Κάρτα, άμεσες πληρωμές SEPA."
    },
    cta: {
    ...
    compliance: {
      items: ["ΕΡΓΑΝΗ ΙΙ", "Ψηφιακή Κάρτα", "ΑΠΔ/ΦΜΥ", "Ειδοποιήσεις SEPA", "e-ΕΦΚΑ"]
    },
    features: {
      title: "Όλα όσα χρειάζεστε για ελληνική μισθοδοσία",
      subtitle: "Αυτόματη συμμόρφωση, απρόσκοπτες ενσωματώσεις, ευτυχισμένοι υπάλληλοι",
      cards: [
        {
          title: "Υπολογίζουμε & κατατίθουμε",
          description: "Ελληνικοί φόροι, κοινωνική ασφάλιση και όλες οι κρατικές δηλώσεις αυτόματα."
        },
        {
          title: "Ώρες εργασίας στη μισθοδοσία",
          description: "Άδειες, αργίες και ωράρια συγχρονίζονται απευθείας από το σύστημά σας."
        },
        {
          title: "Αυτοεξυπηρέτηση υπαλλήλων",
          description: "Οι υπάλληλοι βλέπουν μισθοδοτικά, ενημερώνουν στοιχεία και αιτούνται άδειες."
        },
        {
          title: "Συνδυάζεται με τις εφαρμογές σας",
          description: "Ενσωματώνεται με QuickBooks, Xero και δημοφιλή εργαλεία χρονομέτρησης."
        }
      ]
    },
    howItWorks: {
      ...
      steps: [
        { title: "Σύνδεση εταιρείας & χρόνου", description: "Συνδέστε την επιχείρησή σας και το χρονοδιάγραμμα" },
        { title: "Έλεγχος ωρών & εξαιρέσεων", description: "Ελέγξτε τα φύλλα χρόνου και χειριστείτε προβλήματα" },
        { title: "Εκτέλεση μισθοδοσίας", description: "Αυτόματος υπολογισμός φόρων και εντύπων" },
        { title: "Πληρωμή & Δήλωση", description: "Πληρωμές SEPA και δήλωση ΑΠΔ/ΦΜΥ" }
      ]
    },
    social: {
      title: "Εμπιστεύονται ελληνικές επιχειρήσεις",
      trustedBy: "Εμπιστεύονται ξενοδοχεία, εστιατόρια και επιχειρήσεις σε όλη την Ελλάδα",
      testimonials: [
        {
          quote: "Η μισθοδοσία από 6 ώρες έγινε 15 λεπτά. Μηδέν λάθη με τις δηλώσεις ΕΡΓΑΝΗ.",
          name: "Μαρία Κούρη",
          role: "Διευθύντρια HR, Aegean Hotels"
        },
        {
          quote: "Η αυτοματοποίηση της ελληνικής συμμόρφωσης μας εξοικονομεί €2.000 μηνιαίως.",
          name: "Δημήτρης Σταύρος",
          role: "CFO, Mykonos Restaurants"
        },
        {
          quote: "Οι υπάλληλοί μας αγαπούν την αυτοεξυπηρέτηση. Τέλος οι ερωτήσεις μισθοδοσίας!",
          name: "Έλενα Παπαδάκη",
    ...
    finalCTA: {
      ...
      subline: "Ενωθείτε με εκατοντάδες ελληνικές επιχειρήσεις που αυτοματοποιούν τη μισθοδοσία τους",
      salesCall: "Επικοινωνία πωλήσεων",
      noCredit: "Δεν απαιτείται πιστωτική κάρτα • Δωρεάν δοκιμή 30 ημερών"
    },
    footer: {
      description: "Η σύγχρονη πλατφόρμα μισθοδοσίας για ελληνικές επιχειρήσεις",
      product: "Προϊόν",
      support: "Υποστήριξη",
      legal: "Νομικά",
