...
export default function ErrorTrackingPage() {
  ...
  const translations = {
    en: {
      ...
      subtitle:
        'Fix issues before customers notice - Comprehensive error monitoring and resolution',
      hero: {
        title: 'Proactive Error Management for Greek Payroll Systems',
        subtitle:
          'Advanced real-time error tracking designed specifically for critical Greek payroll operations, government integrations, and SEPA payment processing.',
      ...
      features: {
        ...
        realTime: {
          ...
          description:
            'Instant error detection and alerting across all PayrollSync components and Greek integrations.',
        },
        analytics: {
          title: 'Advanced Analytics',
          description:
            'Deep insights into error patterns, resolution performance, and business impact analysis.',
        },
        integration: {
          title: 'Greek System Integration',
          description:
            'Specialized monitoring for ERGANI II, e-EFKA, and Greek banking system connections.',
        },
        resolution: {
          title: 'Automated Resolution',
          description:
            'AI-powered error classification, automated assignment, and resolution workflow management.',
        },
      },
      benefits: {
        ...
        compliance: {
          ...
          description:
            'Prevent compliance violations with ERGANI II and e-EFKA through immediate error detection and resolution.',
        },
        customer: {
          title: 'Customer Experience Excellence',
          description:
            'Fix issues before they impact employees and HR teams, maintaining trust in payroll accuracy.',
        },
        business: {
          title: 'Business Continuity Assurance',
          description:
            'Minimize payroll disruptions and financial losses through proactive error management.',
        },
      },
      stats: {
    ...
    el: {
      ...
      subtitle:
        'Διορθώστε προβλήματα πριν τα παρατηρήσουν οι πελάτες - Ολοκληρωμένη παρακολούθηση και επίλυση σφαλμάτων',
      hero: {
        title:
          'Προληπτική Διαχείριση Σφαλμάτων για Ελληνικά Συστήματα Μισθοδοσίας',
        subtitle:
          'Προηγμένη παρακολούθηση σφαλμάτων σε πραγματικό χρόνο σχεδιασμένη ειδικά για κρίσιμες ελληνικές λειτουργίες μισθοδοσίας, κυβερνητικές ενσωματώσεις και επεξεργασία πληρωμών SEPA.',
      ...
      features: {
        ...
        realTime: {
          ...
          description:
            'Άμεση ανίχνευση και ειδοποίηση σφαλμάτων σε όλα τα στοιχεία PayrollSync και ελληνικές ενσωματώσεις.',
        },
        analytics: {
          title: 'Προηγμένα Αναλυτικά',
          description:
            'Βαθιά insights σε μοτίβα σφαλμάτων, απόδοση επίλυσης και ανάλυση επιχειρηματικού αντίκτυπου.',
        },
        integration: {
          title: 'Ενσωμάτωση Ελληνικών Συστημάτων',
          description:
            'Εξειδικευμένη παρακολούθηση για συνδέσεις ΕΡΓΑΝΗ ΙΙ, e-ΕΦΚΑ και ελληνικών τραπεζικών συστημάτων.',
        },
        resolution: {
          title: 'Αυτοματοποιημένη Επίλυση',
          description:
            'Κατηγοριοποίηση σφαλμάτων με AI, αυτοματοποιημένη ανάθεση και διαχείριση ροής εργασίας επίλυσης.',
        },
      },
      benefits: {
        title:
          'Γιατί η Παρακολούθηση Σφαλμάτων σε Πραγματικό Χρόνο είναι Κρίσιμη για την Ελληνική Μισθοδοσία',
        compliance: {
          title: 'Προστασία Κυβερνητικής Συμμόρφωσης',
          description:
            'Αποφύγετε παραβιάσεις συμμόρφωσης με ΕΡΓΑΝΗ ΙΙ και e-ΕΦΚΑ μέσω άμεσης ανίχνευσης και επίλυσης σφαλμάτων.',
        },
        customer: {
          title: 'Αριστεία Εμπειρίας Πελάτη',
          description:
            'Διορθώστε προβλήματα πριν επηρεάσουν υπαλλήλους και ομάδες HR, διατηρώντας την εμπιστοσύνη στην ακρίβεια μισθοδοσίας.',
        },
        business: {
          title: 'Διασφάλιση Επιχειρηματικής Συνέχειας',
          description:
            'Ελαχιστοποιήστε τις διαταραχές μισθοδοσίας και τις οικονομικές απώλειες μέσω προληπτικής διαχείρισης σφαλμάτων.',
        },
      },
      stats: {
        ...
        <div className="max-w-7xl mx-auto p-6">
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Deep analysis of error patterns and resolution performance
            </p>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center p-8 bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-semibold mb-4">
                {t.features.resolution.title}
              </h3>
              <p className="text-gray-600 leading-relaxed">
                {t.features.resolution.description}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="p-8 bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-semibold mb-4">
                {t.benefits.customer.title}
              </h3>
              <p className="text-gray-600 leading-relaxed">
                {t.benefits.customer.description}
              </p>
            </div>
            ...
            <div className="p-8 bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 leading-relaxed">
                {t.benefits.business.description}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-red-600 to-orange-600 text-white text-center rounded-2xl p-12">
          ...
          <p className="text-xl text-red-100 mb-8 max-w-2xl mx-auto">
            Start monitoring your Greek payroll systems in real-time and resolve
