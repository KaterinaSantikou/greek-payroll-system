...
export default function ChurnPreventionDemo({ locale = 'en' }: DemoProps) {
  ...
  const translations = {
    en: {
      ...
      hero: {
        ...
        subtitle: 'Advanced AI-powered system that identifies at-risk accounts and implements targeted retention strategies to maximize customer lifetime value and reduce revenue loss.',
      ...
      features: {
        ...
        riskScoring: {
          ...
          description: 'Advanced algorithms analyze customer behavior patterns to predict churn probability with 85% accuracy.'
        },
        proactiveOutreach: {
          title: 'Automated Outreach',
          description: 'Intelligent campaigns automatically trigger personalized retention efforts based on risk level and customer profile.'
        },
        realTimeAlerts: {
          title: 'Real-Time Alerts',
          description: 'Instant notifications to account managers when customer health scores drop or risk factors increase.'
        },
        retentionCampaigns: {
          title: 'Retention Campaigns',
          description: 'Pre-built, customizable campaigns designed to address specific churn risks and re-engage customers.'
        }
      },
      benefits: {
        ...
        revenueProtection: {
          ...
          description: 'Prevent up to 78% of potential churn, protecting millions in recurring revenue through proactive intervention.'
        },
        earlyWarning: {
          title: 'Early Warning System',
          description: 'Identify at-risk customers 60-90 days before cancellation, providing ample time for successful retention efforts.'
        },
        personalizedApproach: {
          title: 'Personalized Retention',
          description: 'Tailored outreach strategies based on customer segment, risk factors, and historical success patterns.'
        }
      },
      riskFactors: {
    ...
    el: {
      ...
      hero: {
        ...
        subtitle: 'Προηγμένο σύστημα τεχνητής νοημοσύνης που εντοπίζει λογαριασμούς υψηλού κινδύνου και εφαρμόζει στοχευμένες στρατηγικές διατήρησης για μεγιστοποίηση της αξίας ζωής πελατών και μείωση απώλειας εσόδων.',
      ...
      features: {
        ...
        riskScoring: {
          ...
          description: 'Προηγμένοι αλγόριθμοι αναλύουν τα πρότυπα συμπεριφοράς πελατών για πρόβλεψη πιθανότητας εγκατάλειψης με 85% ακρίβεια.'
        },
        proactiveOutreach: {
          title: 'Αυτοματοποιημένη Προσέγγιση',
          description: 'Έξυπνες καμπάνιες ενεργοποιούν αυτόματα εξατομικευμένες προσπάθειες διατήρησης βάσει επιπέδου κινδύνου και προφίλ πελάτη.'
        },
        realTimeAlerts: {
          title: 'Ειδοποιήσεις Πραγματικού Χρόνου',
          description: 'Άμεσες ειδοποιήσεις στους υπεύθυνους λογαριασμών όταν οι βαθμοί υγείας πελατών πέφτουν ή αυξάνονται οι παράγοντες κινδύνου.'
        },
        retentionCampaigns: {
          title: 'Καμπάνιες Διατήρησης',
          description: 'Προκατασκευασμένες, προσαρμόσιμες καμπάνιες σχεδιασμένες για αντιμετώπιση συγκεκριμένων κινδύνων εγκατάλειψης και επαναδέσμευση πελατών.'
        }
      },
      benefits: {
        ...
        revenueProtection: {
          ...
          description: 'Αποτρέψτε έως και 78% των πιθανών εγκαταλείψεων, προστατεύοντας εκατομμύρια σε επαναλαμβανόμενα έσοδα μέσω προληπτικής παρέμβασης.'
        },
        earlyWarning: {
          title: 'Σύστημα Έγκαιρης Προειδοποίησης',
          description: 'Εντοπίστε πελάτες υψηλού κινδύνου 60-90 ημέρες πριν την ακύρωση, παρέχοντας άφθονο χρόνο για επιτυχείς προσπάθειες διατήρησης.'
        },
        personalizedApproach: {
          title: 'Εξατομικευμένη Διατήρηση',
          description: 'Προσαρμοσμένες στρατηγικές προσέγγισης βάσει τμήματος πελάτη, παραγόντων κινδύνου και ιστορικών προτύπων επιτυχίας.'
        }
      },
      riskFactors: {
  ...
  const outreachStrategies = [
    { key: 'executiveMeeting', icon: Users, color: 'bg-blue-100 text-blue-600' },
    { key: 'trainingSession', icon: Target, color: 'bg-green-100 text-green-600' },
    { key: 'featureShowcase', icon: Eye, color: 'bg-purple-100 text-purple-600' },
    { key: 'loyaltyProgram', icon: Heart, color: 'bg-red-100 text-red-600' },
    { key: 'contractRenewal', icon: Shield, color: 'bg-orange-100 text-orange-600' },
    { key: 'successPlanning', icon: CheckCircle, color: 'bg-emerald-100 text-emerald-600' }
  ];

  const performanceMetrics = [
    { key: 'churnReduction', value: '78%', icon: TrendingUp, color: 'text-green-600' },
    { key: 'revenueRetained', value: '€2.1M', icon: DollarSign, color: 'text-blue-600' },
    { key: 'successRate', value: '85%', icon: CheckCircle, color: 'text-emerald-600' },
    { key: 'averageRecoveryTime', value: '12 days', icon: Clock, color: 'text-purple-600' }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-white to-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div id="features" className="mb-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center p-8 bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-semibold mb-4">{t.features.riskScoring.title}</h3>
              <p className="text-gray-600 leading-relaxed">{t.features.riskScoring.description}</p>
            </div>
            ...
            <div className="text-center p-8 bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-semibold mb-4">{t.features.proactiveOutreach.title}</h3>
              <p className="text-gray-600 leading-relaxed">{t.features.proactiveOutreach.description}</p>
            </div>
            ...
            <div className="text-center p-8 bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-semibold mb-4">{t.features.realTimeAlerts.title}</h3>
              <p className="text-gray-600 leading-relaxed">{t.features.realTimeAlerts.description}</p>
            </div>
            ...
            <div className="text-center p-8 bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-semibold mb-4">{t.features.retentionCampaigns.title}</h3>
              <p className="text-gray-600 leading-relaxed">{t.features.retentionCampaigns.description}</p>
            </div>
          </div>
        </div>
            ...
            {outreachStrategies.map((strategy, index) => {
              ...
              return (
                <div key={index} className="text-center p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                  <div className={`w-12 h-12 ${strategy.color} rounded-lg flex items-center justify-center mx-auto mb-4`}>
                    <Icon className="h-6 w-6" />
                  </div>
                  <h3 className="font-semibold mb-2">
                    {t.outreachStrategies[strategy.key as keyof typeof t.outreachStrategies]}
                  </h3>
                </div>
              );
            })}
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-8 bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-semibold mb-4">{t.benefits.revenueProtection.title}</h3>
              <p className="text-gray-600 leading-relaxed">{t.benefits.revenueProtection.description}</p>
            </div>
            ...
            <div className="p-8 bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-semibold mb-4">{t.benefits.earlyWarning.title}</h3>
              <p className="text-gray-600 leading-relaxed">{t.benefits.earlyWarning.description}</p>
            </div>
            ...
            <div className="p-8 bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-semibold mb-4">{t.benefits.personalizedApproach.title}</h3>
              <p className="text-gray-600 leading-relaxed">{t.benefits.personalizedApproach.description}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-red-600 to-orange-600 text-white text-center rounded-2xl p-12">
          <h2 className="text-3xl font-bold mb-4">Stop Customer Churn Before It Starts</h2>
          <p className="text-xl text-red-100 mb-8 max-w-2xl mx-auto">
            Transform your customer retention strategy with AI-powered churn prevention that protects revenue and maximizes lifetime value.
          </p>
