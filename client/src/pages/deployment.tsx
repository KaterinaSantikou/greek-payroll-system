...
const DEPLOYMENT_STEPS: DeploymentStep[] = [
  {
    ...
    description:
      'Import properties, cost centers, earnings codes, and employee data',
    ...
    checklist: [
      {
        id: 'properties',
        task: 'Upload property master data',
        completed: false,
      },
      {
        id: 'cost_centers',
        task: 'Configure cost centers per department',
        completed: false,
      },
      {
        id: 'earnings_codes',
        task: 'Set up earnings codes (REG, OT1-3, NIGHT, SUNDAY, etc.)',
        completed: false,
      },
      {
        id: 'employees',
        task: 'Import employee master data with AFM/AMKA',
        completed: false,
      },
      {
        id: 'validation',
        task: 'Validate data integrity and Greek compliance',
        completed: false,
      },
    ],
  },
  {
    ...
    checklist: [
      {
        id: 'break_rules',
        task: 'Set break policies (15min, 30min, lunch)',
        completed: false,
      },
      {
        id: 'overtime_tiers',
        task: 'Configure OT tiers (25%, 50%, 75%)',
        completed: false,
      },
      {
        id: 'night_bands',
        task: 'Define night shift time bands',
        completed: false,
      },
      { id: 'geofences', task: 'Set up property geofences', completed: false },
      {
        id: 'cba_rules',
        task: 'Apply collective bargaining agreement rules',
        completed: false,
      },
    ],
  },
  {
    ...
    checklist: [
      {
        id: 'kiosk_setup',
        task: 'Install and configure kiosk devices',
        completed: false,
      },
      {
        id: 'qr_generation',
        task: 'Generate QR codes for departments',
        completed: false,
      },
      {
        id: 'device_binding',
        task: 'Bind devices to specific properties',
        completed: false,
      },
      {
        id: 'offline_sync',
        task: 'Test offline mode and sync capabilities',
        completed: false,
      },
      {
        id: 'biometric_setup',
        task: 'Configure biometric verification (if enabled)',
        completed: false,
      },
    ],
  },
  {
    ...
    checklist: [
      {
        id: 'ergani_credentials',
        task: 'Configure ERGANI II credentials',
        completed: false,
      },
      {
        id: 'ergani_test',
        task: 'Test ERGANI punch submission',
        completed: false,
      },
      {
        id: 'payroll_sandbox',
        task: 'Connect to Payroll API sandbox',
        completed: false,
      },
      {
        id: 'payroll_prod',
        task: 'Switch to Payroll API production',
        completed: false,
      },
      {
        id: 'webhook_setup',
        task: 'Configure webhook notifications',
        completed: false,
      },
    ],
  },
  {
    ...
    checklist: [
      {
        id: 'dept_selection',
        task: 'Select pilot department',
        completed: false,
      },
      {
        id: 'test_employees',
        task: 'Onboard test employees',
        completed: false,
      },
      {
        id: 'punch_testing',
        task: 'Test punch in/out workflows',
        completed: false,
      },
      {
        id: 'exception_review',
        task: 'Review and resolve exceptions',
        completed: false,
      },
      {
        id: 'reports_validation',
        task: 'Validate timesheet reports',
        completed: false,
      },
    ],
  },
  {
    ...
    checklist: [
      { id: 'full_rollout', task: 'Enable all departments', completed: false },
      {
        ...
        task: 'Train department supervisors',
        completed: false,
      },
      {
        id: 'employee_orientation',
        task: 'Conduct employee orientation',
        completed: false,
      },
      {
        id: 'support_docs',
        task: 'Provide support documentation',
        completed: false,
      },
      {
        id: 'escalation_setup',
        task: 'Set up escalation procedures',
        completed: false,
      },
    ],
  },
...
export default function DeploymentPage() {
  ...
  const [deploymentSteps, setDeploymentSteps] =
    useState<DeploymentStep[]>(DEPLOYMENT_STEPS);
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-muted-foreground mt-2">
              Systematic 60-90 minute deployment process for PayrollSync
              implementation
            </p>
          </div>
