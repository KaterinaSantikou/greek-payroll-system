...
export default function SchedulesPage() {
  ...
  const contractTypeInfo =
    CONTRACT_TYPES[scheduleData.contractType as keyof typeof CONTRACT_TYPES];
  const scheduleTypeInfo =
    SCHEDULE_TYPES[scheduleData.scheduleType as keyof typeof SCHEDULE_TYPES];
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-gray-600">
            Ρύθμιση ωραρίων και συμβάσεων εργασίας σύμφωνα με το ελληνικό
            εργατικό δίκαιο
          </p>
        </div>
      </div>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={value =>
                      setScheduleData({ ...scheduleData, scheduleType: value })
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="standardWeeklyHours">
                      Εβδομαδιαίες Ώρες
                    </Label>
                    <Input
                      ...
                      onChange={e =>
                        setScheduleData({
                          ...scheduleData,
                          standardWeeklyHours: parseInt(e.target.value),
                        })
                      }
                    />
                  </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center space-x-2">
                    <Switch
                      ...
                      onCheckedChange={checked =>
                        setScheduleData({
                          ...scheduleData,
                          flexibleWorkArrangement: checked,
                        })
                      }
                    />
                  ...
                  {scheduleData.flexibleWorkArrangement && (
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <Label htmlFor="remoteWorkDays">
                          Ημέρες Τηλεργασίας/Εβδομάδα
                        </Label>
                        <Input
                          id="remoteWorkDays"
                          type="number"
                          ...
                          onChange={e =>
                            setScheduleData({
                              ...scheduleData,
                              remoteWorkDays: parseInt(e.target.value),
                            })
                          }
                        />
                      </div>
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          onChange={e =>
                            setScheduleData({
                              ...scheduleData,
                              coreWorkingHours: e.target.value,
                            })
                          }
                        />
                      </div>
                    ...
                    <div className="flex items-center space-x-2">
                      <Switch
                        ...
                        onCheckedChange={checked =>
                          setScheduleData({
                            ...scheduleData,
                            compressedWorkweek: checked,
                          })
                        }
                      />
                      <Label htmlFor="compressedWorkweek">
                        Τετραήμερη Εργασία
                      </Label>
                    </div>
                  </div>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-3">
                  <h4 className="font-medium">
                    Ευρωπαϊκή Οδηγία Χρόνου Εργασίας
                  </h4>
                  <div className="space-y-2">
                    <div className="flex justify-between">
                      ...
                      <Badge variant="outline">
                        {EU_WORKING_TIME_LIMITS.MAX_WEEKLY_HOURS}h
                      </Badge>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-sm">Μέγιστες ημερήσιες ώρες</span>
                      <Badge variant="outline">
                        {EU_WORKING_TIME_LIMITS.MAX_DAILY_HOURS}h
                      </Badge>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-sm">
                      ...
                      <Badge variant="outline">
                        {EU_WORKING_TIME_LIMITS.MIN_REST_BETWEEN_SHIFTS}h
                      </Badge>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-sm">
                        Μέγιστες συνεχόμενες ημέρες
                      </span>
                      <Badge variant="outline">
                        {EU_WORKING_TIME_LIMITS.MAX_CONSECUTIVE_DAYS}
                      </Badge>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between">
                      ...
                      <Badge variant="secondary">
                        €{GREEK_LABOR_REQUIREMENTS.MINIMUM_WAGE_2025}
                      </Badge>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-sm">Ημέρες ετήσιας άδειας</span>
                      <Badge variant="secondary">
                        {GREEK_LABOR_REQUIREMENTS.ANNUAL_LEAVE_DAYS}
                      </Badge>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-sm">
                        Μέγιστη δοκιμαστική περίοδος
                      </span>
                      <Badge variant="secondary">
                        {GREEK_LABOR_REQUIREMENTS.MAX_TRIAL_PERIOD_MONTHS} μήνες
                      </Badge>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-sm">Επίδομα Κυριακής</span>
                      <Badge variant="secondary">
                        {GREEK_LABOR_REQUIREMENTS.SUNDAY_WORK_PREMIUM * 100}%
                      </Badge>
                    </div>
                  </div>
                </div>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <Select
                  ...
                  onValueChange={value =>
                    setScheduleData({ ...scheduleData, contractType: value })
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div className="space-y-3">
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between">
                        <span className="text-sm">
                          Ελάχιστες εβδομαδιαίες ώρες
                        </span>
                        <Badge variant="outline">
                          {contractTypeInfo.minWeeklyHours || 'Δ/Ι'}h
                        </Badge>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-sm">
                        ...
                        <Badge variant="outline">
                          {contractTypeInfo.maxWeeklyHours || 'Δ/Ι'}h
                        </Badge>
                      </div>
                      <div className="flex justify-between">
                      ...
                      {contractTypeInfo.trialPeriodMonths && (
                        <>
                          <div className="flex justify-between">
                            ...
                            <Badge variant="outline">
                              {contractTypeInfo.trialPeriodMonths.min} μήνες
                            </Badge>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-sm">Μέγιστη διάρκεια</span>
                            <Badge variant="outline">
                              {contractTypeInfo.trialPeriodMonths.max} μήνες
                            </Badge>
                          </div>
                        </>
                      )}
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <Label htmlFor="contractEndDate">
                    Ημερομηνία Λήξης (για ορισμένου χρόνου)
                  </Label>
                  <Input
                    id="contractEndDate"
                    type="date"
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center space-x-2">
                <Switch
                  ...
                  onCheckedChange={checked =>
                    setScheduleData({
                      ...scheduleData,
                      trialPeriodRequired: checked,
                    })
                  }
                />
                <Label htmlFor="trialPeriodRequired">
                  Απαιτείται δοκιμαστική περίοδος
                </Label>
              </div>
              ...
              {scheduleData.trialPeriodRequired && (
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <Label htmlFor="trialPeriodStartDate">
                        Ημερομηνία Έναρξης
                      </Label>
                      <Input
                        ...
                        onChange={e =>
                          setScheduleData({
                            ...scheduleData,
                            trialPeriodStartDate: e.target.value,
                          })
                        }
                      />
                    </div>
                    ...
                    <div>
                      <Label htmlFor="trialPeriodDuration">
                        Διάρκεια (μήνες)
                      </Label>
                      <Input
                        ...
                        onChange={e =>
                          setScheduleData({
                            ...scheduleData,
                            trialPeriodDuration: parseInt(e.target.value),
                          })
                        }
                      />
                    </div>
                  ...
                  {calculatedData?.trialPeriod && (
                    <div className="bg-blue-50 p-4 rounded-lg">
                      <h4 className="font-medium mb-2">
                        Υπολογισμένη Δοκιμαστική Περίοδος
                      </h4>
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          ...
                          <p className="font-medium">
                            {calculatedData.trialPeriod.recommendedDuration}{' '}
                            μήνες
                          </p>
                        </div>
                        <div>
                          ...
                          <p className="font-medium">
                            {calculatedData.trialPeriod.endDate.toLocaleDateString(
                              'el-GR'
                            )}
                          </p>
                        </div>
                        <div>
                          <span className="text-sm text-gray-600">
                            Παράταση επιτρέπεται:
                          </span>
                          <Badge
                            variant={
                              calculatedData.trialPeriod.extensionAllowed
                                ? 'default'
                                : 'secondary'
                            }
                          >
                        ...
                        <div>
                          ...
                          <p className="font-medium">
                            {calculatedData.trialPeriod.reviewDates.length}{' '}
                            προγραμματισμένες
                          </p>
                        </div>
                      </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                {complianceCheck ? (
                  <>
                    <div
                      className={`p-3 rounded-lg ${complianceCheck.isCompliant ? 'bg-green-50 border border-green-200' : 'bg-red-50 border border-red-200'}`}
                    >
                      <div className="flex items-center gap-2">
                        ...
                        <span
                          className={`font-medium ${complianceCheck.isCompliant ? 'text-green-800' : 'text-red-800'}`}
                        >
                          {complianceCheck.isCompliant
                            ? 'Συμμορφούται πλήρως'
                            : 'Εντοπίστηκαν παραβάσεις'}
                        </span>
                      </div>
                    </div>
                    ...
                    {complianceCheck.violations.length > 0 && (
                      <div className="space-y-2">
                        ...
                        {complianceCheck.violations.map(
                  ...
                  <p className="text-gray-500">
                    Κάντε υπολογισμό ωραρίου για έλεγχο συμμόρφωσης
                  </p>
                )}
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                {calculatedData?.premiums ? (
                  <>
                    <div className="text-center p-3 bg-blue-50 rounded-lg">
                      <div className="text-2xl font-bold text-blue-600">
                        {(
                          calculatedData.premiums.totalPremiumRate * 100
                        ).toFixed(1)}
                        %
                      </div>
                    ...
                    <div className="space-y-3">
                      ...
                      {calculatedData.premiums.premiumBreakdown.map(
                        (premium: any, index: number) => (
                          <div
                            key={index}
                  ...
                  <p className="text-gray-500">
                    Κάντε υπολογισμό ωραρίου για προβολή επιδομάτων
                  </p>
                )}
              </CardContent>
            </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-7 gap-2">
              {calculatedData.schedulePattern.pattern.map(
                (day: any, index: number) => (
                  <div
                    key={index}
                    className={`p-3 rounded-lg border ${day.workHours > 0 ? 'bg-blue-50 border-blue-200' : 'bg-gray-50 border-gray-200'}`}
                  >
            ...
            <div className="mt-4 text-center">
              <Badge variant="secondary" className="text-lg">
                Σύνολο: {calculatedData.schedulePattern.totalWeeklyHours}{' '}
                ώρες/εβδομάδα
              </Badge>
            </div>
          </CardContent>
