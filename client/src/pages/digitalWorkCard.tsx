...
export default function DigitalWorkCardPage() {
  ...
  const [userRole, setUserRole] = useState<
    'employee' | 'supervisor' | 'hr' | 'compliance'
  >('employee');
  ...
  const [pendingExceptions, setPendingExceptions] = useState([
    {
      ...
      description: 'Αίτημα για 2 ώρες υπερωρίες',
      requestedAt: '2025-01-19T16:00:00',
    },
    {
      id: 'exc_002',
      employeeId: 'emp_003',
      type: 'manual_entry',
      description: 'Ξέχασα να κάνω check-out χθες',
      requestedAt: '2025-01-19T08:30:00',
    },
  ]);
  ...
  const [forgottenClockAlerts, setForgottenClockAlerts] = useState([
    {
      employeeId: 'emp_001',
      lastSeen: '2025-01-19T12:00:00',
      alert: 'Δεν έχετε κάνει check-out για διάλειμμα εδώ και 4 ώρες',
    },
  ]);
  ...
  const createWorkCardEvent = async () => {
    ...
    if (eventData.eventType === 'check_in') {
      ...
      // Complete session
      const allEvents = [
        ...recentEvents.filter(e => e.employeeId === currentEmployee.id),
        event,
      ];
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-gray-600">
              Καταγραφή χρόνου εργασίας και συγχρονισμός ERGANI II
            </p>
          </div>
        </div>
                ...
                <Card className="border-yellow-200 bg-yellow-50">
                  ...
                  <CardContent>
                    {forgottenClockAlerts.map((alert, index) => (
                      <div
                        key={index}
                        className="p-3 bg-yellow-100 border border-yellow-200 rounded"
                      >
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="text-center p-6 border-2 border-dashed border-blue-300 rounded-lg bg-blue-50">
                    ...
                    <div className="text-sm text-blue-600">
                      Φέρτε κοντά το τηλέφωνο ή την κάρτα σας
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="flex items-center space-x-2">
                      <Switch
                        ...
                        onCheckedChange={checked =>
                          setEventData({
                            ...eventData,
                            biometricVerified: checked,
                          })
                        }
                      />
                      <Label htmlFor="biometricVerified">
                    ...
                    <div className="flex items-center space-x-2">
                      <Switch
                        ...
                        onCheckedChange={checked =>
                          setEventData({ ...eventData, photoVerified: checked })
                        }
                      />
                      <Label htmlFor="photoVerified">
                        Φωτογραφική Επαλήθευση
                      </Label>
                    </div>
                  </div>
                  ...
                  >
                    {eventData.eventType === 'check_in' && (
                      <PlayCircle className="mr-2 h-5 w-5" />
                    )}
                    {eventData.eventType === 'check_out' && (
                      <StopCircle className="mr-2 h-5 w-5" />
                    )}
                    {eventData.eventType === 'break_start' && (
                      <Coffee className="mr-2 h-5 w-5" />
                    )}
                    {eventData.eventType === 'location_change' && (
                    ...
                    <div className="p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                      <div className="flex items-center gap-2 text-yellow-800">
                        ...
                        <span className="text-sm">
                          Λειτουργία Offline - {pendingEvents.length} γεγονότα
                          σε αναμονή συγχρονισμού
                        </span>
                      </div>
                    </div>
                  )}
                ...
                <CardContent className="space-y-3">
                  ...
                  <div>
                    ...
                    <div>
                      {
                        HOTEL_WORK_PATTERNS[
                          currentEmployee.department as keyof typeof HOTEL_WORK_PATTERNS
                        ]?.name
                      }
                    </div>
                  </div>
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="font-mono">
                          {formatTime(activeSession.checkIn.timestamp)}
                        </span>
                      </div>
                      {activeSession.checkOut && (
                        <div className="flex justify-between text-sm">
                          <span>Έξοδος:</span>
                          <span className="font-mono">
                            {formatTime(activeSession.checkOut.timestamp)}
                          </span>
                        </div>
                      )}
                      <div className="flex justify-between text-sm">
                        ...
                        <span>
                          ...
                          {formatDuration(activeSession.breakMinutes)})
                        </span>
                      </div>
                    </div>
                  ...
                  <CardContent className="space-y-4">
                    <div className="space-y-3">
                      <div className="flex justify-between">
                        ...
                        <span>
                          €
                          {activeSession.payrollCalculations.regularPay.toFixed(
                            2
                          )}
                        </span>
                      </div>
                      {activeSession.payrollCalculations.overtimePay > 0 && (
                        <div className="flex justify-between">
                          ...
                          <span>
                            €
                            {activeSession.payrollCalculations.overtimePay.toFixed(
                              2
                            )}
                          </span>
                        </div>
                      )}
                      {activeSession.payrollCalculations.nightShiftPremium >
                        0 && (
                        <div className="flex justify-between">
                          <span>Νυχτερινό Επίδομα (+25%):</span>
                          <span>
                            €
                            {activeSession.payrollCalculations.nightShiftPremium.toFixed(
                              2
                            )}
                          </span>
                        </div>
                      ...
                      {activeSession.payrollCalculations.breakPay > 0 && (
                        <div className="flex justify-between">
                          ...
                          <span>
                            €
                            {activeSession.payrollCalculations.breakPay.toFixed(
                              2
                            )}
                          </span>
                        </div>
                      ...
                      <div className="flex justify-between font-bold text-lg">
                        ...
                        <span>
                          €
                          {activeSession.payrollCalculations.totalPay.toFixed(
                            2
                          )}
                        </span>
                      </div>
              ...
              <Card className="lg:col-span-2">
                ...
                <CardContent>
                  <div className="text-center py-8">
                    ...
                    <p className="text-gray-600">
                      Δεν υπάρχει ενεργή βάρδια. Καταγράψτε είσοδο για έναρξη.
                    </p>
                  </div>
                </CardContent>
              </Card>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Καθαρά, επαληθευμένα δεδομένα που ρέουν απευθείας στη
                  μισθοδοσία
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <Select>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="main_hotel">
                        Κυρίως Ξενοδοχείο
                      </SelectItem>
                      <SelectItem value="spa_center">Κέντρο SPA</SelectItem>
                      <SelectItem value="conference_center">
                        Κέντρο Συνεδρίων
                      </SelectItem>
                    </SelectContent>
                  </Select>
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={value =>
                      setExportData({ ...exportData, format: value as any })
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
                ...
                <div className="space-y-2">
                  <div className="flex items-center space-x-2">
                    <Switch
                      ...
                      onCheckedChange={checked =>
                        setExportData({ ...exportData, includeBreaks: checked })
                      }
                    />
                    <Label htmlFor="includeBreaks">
                      Συμπερίληψη Διαλειμμάτων
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Switch
                      ...
                      onCheckedChange={checked =>
                        setExportData({
                          ...exportData,
                          includeViolations: checked,
                        })
                      }
                    />
                    <Label htmlFor="includeViolations">
                      Συμπερίληψη Παραβάσεων
                    </Label>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div className="p-3 bg-green-50 border border-green-200 rounded">
                    ...
                    <div className="text-sm text-green-700 mt-1">
                      ✓ 24 εργαζόμενοι, 168 συνολικές ώρες
                      <br />
                      ✓ Όλα τα γεγονότα συγχρονισμένα με ERGANI II
                      <br />✓ Υπολογισμοί μισθοδοσίας επαληθευμένοι
                    </div>
                  </div>
                  ...
                  <div className="p-3 bg-blue-50 border border-blue-200 rounded">
                    <div className="text-sm text-blue-700">
                      <strong>Συνολικό Κόστος Μισθοδοσίας:</strong> €2,847.50
                      <br />
                      <span className="text-xs">
                        Βασικές ώρες + Υπερωρίες + Επιδόματα
                      </span>
                    </div>
                  </div>
                </div>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="font-medium text-sm">
                            {log.event} - {log.employee}
                          </div>
                          <div className="text-xs text-gray-600">
                            {log.erganiId
                              ? `ERGANI ID: ${log.erganiId}`
                              : 'Εκκρεμής συγχρονισμός'}
                          </div>
                        </div>
                      </div>
                      <div className="text-right">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="p-3 bg-blue-50 border border-blue-200 rounded">
                  ...
                  <div className="text-sm text-blue-700">
                    ...
                    <br />✓ Digital signatures για κρίσιμα γεγονότα
                  </div>
                </div>
              </CardContent>
            </Card>
                  ...
                  <div key={index} className="p-4 border rounded-lg bg-gray-50">
                    <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 text-sm">
                      ...
                      <div>
                        ...
                        <div className="text-gray-600">
                          Επαλήθευση: {log.verification}
                        </div>
                        <div className="text-gray-600">
                          Διάρκεια: {log.duration}
                        </div>
                      </div>
                      <div>
                        <div className="font-medium">
              ...
              <div className="space-y-3">
                {recentEvents.length > 0 ? (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-sm text-gray-600">
                            {event.location.propertyName} -{' '}
                            {event.metadata.departmentCode}
                          </div>
                        </div>
                      </div>
                      <div className="text-right">
                        ...
                        <div className="flex items-center gap-1 text-xs">
                          ...
                          >
                            ERGANI{' '}
                            {event.erganiStatus.synced ? 'OK' : 'Pending'}
                          </span>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="text-gray-600">
                      Δεν υπάρχουν πρόσφατα γεγονότα
                    </p>
                  </div>
                )}
              </div>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    >
                      {isOnline
                        ? 'Συνδεδεμένο στο ERGANI II'
                        : 'Αποσυνδεδεμένο από ERGANI II'}
                    </span>
                  </div>
                </div>
                ...
                {pendingEvents.length > 0 && (
                  <div className="p-3 bg-yellow-50 border border-yellow-200 rounded">
                    ...
                    <p className="text-sm text-yellow-700">
                      {pendingEvents.length} γεγονότα θα συγχρονιστούν όταν
                      επανέλθει η σύνδεση
                    </p>
                  </div>
                )}
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={value =>
                      setDeviceInfo({ ...deviceInfo, type: value as any })
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
                ...
                <div>
                  ...
                  <Input
                    ...
                    value={deviceInfo.ip || ''}
                    onChange={e =>
                      setDeviceInfo({ ...deviceInfo, ip: e.target.value })
                    }
                  />
                </div>
              </CardContent>
