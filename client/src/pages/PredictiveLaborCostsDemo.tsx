...
export default function PredictiveLaborCostsDemo({ locale = 'en' }: DemoProps) {
  ...
  const translations = {
    en: {
      ...
      hero: {
        ...
        subtitle: 'Sophisticated predictive modeling platform that accurately forecasts monthly payroll expenses using Greek market intelligence, seasonal patterns, regulatory changes, and economic indicators to enable precise budgeting and strategic workforce planning.',
      ...
      features: {
        ...
        predictiveModeling: {
          ...
          description: 'AI-powered forecasting algorithms that analyze historical data, market trends, and regulatory changes to predict future labor costs with 87% accuracy.'
        },
        scenarioAnalysis: {
          title: 'Scenario Analysis',
          description: 'Multiple forecasting scenarios including optimistic, baseline, and pessimistic projections with probability assessments and risk analysis.'
        },
        seasonalIntelligence: {
          title: 'Seasonal Intelligence',
          description: 'Advanced seasonal pattern recognition for Greek markets, accounting for tourism cycles, holiday periods, and industry-specific fluctuations.'
        },
        costDriverTracking: {
          title: 'Cost Driver Tracking',
          description: 'Comprehensive monitoring of regulatory, market, seasonal, and operational factors that influence labor costs with trend analysis.'
        }
      },
      benefits: {
        ...
        budgetAccuracy: {
          ...
          description: 'Improve budget planning accuracy by 45% with precise monthly forecasts that account for all cost variables and seasonal fluctuations.'
        },
        riskMitigation: {
          title: 'Risk Mitigation',
          description: 'Identify and prepare for cost increases up to 6 months in advance, enabling proactive budget adjustments and risk management.'
        },
        strategicPlanning: {
          title: 'Strategic Planning',
          description: 'Enable long-term workforce planning with accurate cost projections that support hiring decisions and capacity management.'
        }
      },
      forecastComponents: {
    ...
    el: {
      ...
      hero: {
        ...
        subtitle: 'Εξελιγμένη πλατφόρμα προβλεπτικής μοντελοποίησης που προβλέπει με ακρίβεια μηνιαία έξοδα μισθοδοσίας χρησιμοποιώντας ελληνική νοημοσύνη αγοράς, εποχικά πρότυπα, κανονιστικές αλλαγές και οικονομικούς δείκτες για να επιτρέψει ακριβή προϋπολογισμό και στρατηγικό σχεδιασμό εργατικού δυναμικού.',
      ...
      features: {
        ...
        predictiveModeling: {
          ...
          description: 'Αλγόριθμοι πρόβλεψης με τεχνητή νοημοσύνη που αναλύουν ιστορικά δεδομένα, τάσεις αγοράς και κανονιστικές αλλαγές για πρόβλεψη μελλοντικού κόστους εργασίας με ακρίβεια 87%.'
        },
        scenarioAnalysis: {
          title: 'Ανάλυση Σεναρίων',
          description: 'Πολλαπλά σενάρια πρόβλεψης συμπεριλαμβανομένων αισιόδοξων, βασικών και απαισιόδοξων προβολών με αξιολογήσεις πιθανότητας και ανάλυση κινδύνων.'
        },
        seasonalIntelligence: {
          title: 'Εποχική Νοημοσύνη',
          description: 'Προηγμένη αναγνώριση εποχικών προτύπων για ελληνικές αγορές, λαμβάνοντας υπόψη τουριστικούς κύκλους, περιόδους διακοπών και διακυμάνσεις ειδικές για τον κλάδο.'
        },
        costDriverTracking: {
          title: 'Παρακολούθηση Παραγόντων Κόστους',
          description: 'Περιεκτική παρακολούθηση κανονιστικών, αγοραίων, εποχικών και λειτουργικών παραγόντων που επηρεάζουν το κόστος εργασίας με ανάλυση τάσεων.'
        }
      },
      benefits: {
        title: 'Γιατί το Προβλεπτικό Κόστος Εργασίας Μεταμορφώνει τον Σχεδιασμό Προϋπολογισμού',
        budgetAccuracy: {
          title: 'Ακρίβεια Προϋπολογισμού',
          description: 'Βελτιώστε την ακρίβεια σχεδιασμού προϋπολογισμού κατά 45% με ακριβείς μηνιαίες προβλέψεις που λαμβάνουν υπόψη όλες τις μεταβλητές κόστους και εποχικές διακυμάνσεις.'
        },
        riskMitigation: {
          title: 'Μείωση Κινδύνων',
          description: 'Εντοπίστε και προετοιμαστείτε για αυξήσεις κόστους έως 6 μήνες εκ των προτέρων, επιτρέποντας προληπτικές προσαρμογές προϋπολογισμού και διαχείριση κινδύνων.'
        },
        strategicPlanning: {
          title: 'Στρατηγικός Σχεδιασμός',
          description: 'Επιτρέψτε μακροπρόθεσμο σχεδιασμό εργατικού δυναμικού με ακριβείς προβολές κόστους που υποστηρίζουν αποφάσεις πρόσληψης και διαχείρισης χωρητικότητας.'
        }
      },
      forecastComponents: {
  ...
  const performanceMetrics = [
    { key: 'predictedAnnualCost', value: '€3.74M', icon: Euro, color: 'text-green-600' },
    { key: 'forecastAccuracy', value: '87.2%', icon: Target, color: 'text-blue-600' },
    { key: 'confidenceLevel', value: '82.1%', icon: CheckCircle, color: 'text-purple-600' },
    { key: 'seasonalVariation', value: '47.3%', icon: Calendar, color: 'text-orange-600' }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div id="features" className="mb-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center p-8 bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-semibold mb-4">{t.features.predictiveModeling.title}</h3>
              <p className="text-gray-600 leading-relaxed">{t.features.predictiveModeling.description}</p>
            </div>
            ...
            <div className="text-center p-8 bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-semibold mb-4">{t.features.scenarioAnalysis.title}</h3>
              <p className="text-gray-600 leading-relaxed">{t.features.scenarioAnalysis.description}</p>
            </div>
            ...
            <div className="text-center p-8 bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-semibold mb-4">{t.features.seasonalIntelligence.title}</h3>
              <p className="text-gray-600 leading-relaxed">{t.features.seasonalIntelligence.description}</p>
            </div>
            ...
            <div className="text-center p-8 bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-semibold mb-4">{t.features.costDriverTracking.title}</h3>
              <p className="text-gray-600 leading-relaxed">{t.features.costDriverTracking.description}</p>
            </div>
          </div>
        </div>
              ...
              return (
                <div key={index} className="text-center p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                  ...
                  <h3 className="font-semibold mb-2 text-sm">
                    {t.forecastComponents[component.key as keyof typeof t.forecastComponents]}
                  </h3>
                </div>
              );
            })}
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="p-8 bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-semibold mb-4">{t.benefits.strategicPlanning.title}</h3>
              <p className="text-gray-600 leading-relaxed">{t.benefits.strategicPlanning.description}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white text-center rounded-2xl p-12">
          <h2 className="text-3xl font-bold mb-4">Transform Your Budget Planning Today</h2>
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Enable precise workforce cost forecasting with advanced predictive modeling that accounts for Greek market conditions, seasonal patterns, and regulatory changes for strategic budget planning.
          </p>
