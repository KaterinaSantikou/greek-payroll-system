...
const translations = {
  'en-US': {
    ...
    explainYourPay: "What changed since last month",
    ...
    addIban: "Add IBAN",
    addTaxId: "Add Tax ID (AFM)"
  },
  'el-GR': {
    welcome: "Καλώς ήρθατε πίσω",
    nextPayday: "Επόμενη πληρωμή",
    netEstimate: "Καθαρά (εκτίμηση)",
    hoursThisWeek: "Ώρες αυτής της εβδομάδας",
    leaveBalance: "Υπόλοιπο άδειας", 
    explainYourPay: "Τι άλλαξε σε σχέση με τον προηγούμενο μήνα",
    ...
    openTimesheet: "Άνοιγμα κάρτας",
    requestLeave: "Αίτημα άδειας",
    seeFullExplanation: "Πλήρης Εξήγηση",
    viewSchedule: "Προβολή Προγράμματος",
    openTimeline: "Άνοιγμα χρονογραμμής", 
    worked: "εργάστηκε",
    ...
    addIban: "Προσθήκη IBAN",
    addTaxId: "Προσθήκη ΑΦΜ"
  }
};
