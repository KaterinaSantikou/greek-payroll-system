...
function ABTestedButton({ variant, trackConversion }: { variant?: ButtonConfig; trackConversion?: (value?: number) => void }) {
  const config = variant || { color: 'blue' as const, text: 'Get Started', size: 'default' as const };
...
function ABTestedForm({ variant, trackConversion }: { variant?: FormConfig; trackConversion?: (value?: number) => void }) {
  ...
  return (
    <Card className="w-full max-w-md">
      ...
      <CardContent>
        <form onSubmit={handleSubmit} className={`space-y-4 ${config.layout === 'horizontal' ? 'flex flex-row space-y-0 space-x-2' : ''}`}>
...
export default function ABTestingDemo() {
  const [manualConversions, setManualConversions] = useState<Record<string, number>>({});
      ...
      ABTestManager.createTest({
        ...
        variants: [
          ...
          },
          {
            ...
            isControl: false,
            trafficWeight: 25,
            config: { color: 'orange', text: 'Start Free Trial', size: 'large' },
            metrics: { impressions: 0, conversions: 0, conversionRate: 0 }
          },
          {
            id: 'variant-red',
    ...
    <div className="container mx-auto py-8 px-4 max-w-6xl">
      <div className="mb-8">
        ...
        <p className="text-lg text-gray-600 dark:text-gray-400 mb-6">
          Systematically optimize conversion rates with data-driven experiments and statistical analysis.
        </p>
            ...
            <CardContent className="pt-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">95% confidence intervals</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="pt-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">React hooks & components</p>
                </div>
              </div>
            </CardContent>
          </Card>
      ...
      <Tabs defaultValue="examples" className="space-y-6">
        ...
        <TabsContent value="examples" className="space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Testing different button colors and text for optimal conversion
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="border rounded-lg p-4 bg-gray-50 dark:bg-gray-800">
                  ...
                  <div className="text-center">
                    <ABTestComponent testId="demo-button-test">
                      {(props: { variant?: ButtonConfig; trackConversion?: (value?: number) => void }) => <ABTestedButton {...props} />}
                    </ABTestComponent>
                  </div>
                </div>
                ...
                <Button 
                  ...
                  className="w-full"
                >
                  Simulate {manualConversions['demo-button-test'] || 0} Conversions
                </Button>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="border rounded-lg p-4 bg-gray-50 dark:bg-gray-800">
                  ...
                  <div className="flex justify-center">
                    <ABTestComponent testId="demo-form-test">
                      {(props: { variant?: FormConfig; trackConversion?: (value?: number) => void }) => <ABTestedForm {...props} />}
                    </ABTestComponent>
                  </div>
                </div>
                ...
                <Button 
                  ...
                  className="w-full"
                >
                  Simulate {manualConversions['demo-form-test'] || 0} Conversions
                </Button>
              </CardContent>
            </Card>
          </div>
          ...
          <Alert>
            ...
            <AlertDescription>
              <strong>Live Demo:</strong> These are real A/B tests running in your browser! 
              Click the buttons and submit forms to generate conversion events, then check the 
              Analytics tab to see statistical analysis in real-time.
            </AlertDescription>
          </Alert>
        </TabsContent>
        ...
        <TabsContent value="integration" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Learn how to add A/B testing to your components</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div>
                <h4 className="font-semibold mb-3">1. Using the useABTest Hook</h4>
  ...
  return (
    ...
    >
      {variant?.config.text || 'Click Me'}
              ...
              <div>
                <h4 className="font-semibold mb-3">2. Using the ABTestComponent</h4>
                <pre className="bg-gray-100 dark:bg-gray-800 p-4 rounded text-sm overflow-x-auto">
{`import { ABTestComponent } from '@/components/ABTestComponent';
      ...
      config: { title: 'Start Your Journey Today' }
              ...
              <div className="border-t pt-4">
                ...
                <ul className="space-y-2 text-sm text-gray-600">
                  <li>• <strong>Statistical Significance:</strong> Automatic p-value and confidence interval calculation</li>
                  <li>• <strong>User Consistency:</strong> Same user always sees the same variant</li>
                  <li>• <strong>Traffic Allocation:</strong> Control what percentage of users enter the test</li>
                  <li>• <strong>Multiple Variants:</strong> Test more than just A/B - support for A/B/C/D/... testing</li>
                  <li>• <strong>Conversion Tracking:</strong> Track any event as a conversion (clicks, signups, purchases)</li>
                  <li>• <strong>Real-time Analytics:</strong> Live statistical analysis and recommendations</li>
                </ul>
              </div>
            </CardContent>
          </Card>
        ...
        <TabsContent value="analytics" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Real-time statistical analysis of your A/B tests</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-6">
                    ...
                    <div key={testId} className="border rounded-lg p-4">
                      ...
                      <div className="space-y-3">
                        {results.results.map(result => (
                          <div key={result.variantId} className="flex justify-between items-center bg-gray-50 dark:bg-gray-800 rounded p-3">
                            <div>
                              <span className="font-medium">{result.name}</span>
                              {result.isControl && <Badge variant="outline" className="ml-2">Control</Badge>}
                              {results.winner === result.variantId && (
                                <Badge className="ml-2 bg-green-100 text-green-800">Winner</Badge>
                              )}
                            </div>
                            <div className="text-right">
                              <div className="font-semibold">{result.metrics.conversionRate.toFixed(2)}%</div>
                      ...
                      {results.isStatisticallySignificant ? (
                        <Alert className="mt-4">
                          ...
                          <AlertDescription>
                            <strong>Statistically Significant!</strong> We can be {results.confidence.toFixed(1)}% confident 
                            that the difference is real, not due to chance.
                          </AlertDescription>
                        </Alert>
                      ) : (
                        <Alert className="mt-4">
                          ...
                          <AlertDescription>
                            <strong>Not Yet Significant.</strong> More data needed to reach statistical significance. 
                            Current confidence: {results.confidence.toFixed(1)}%
                          </AlertDescription>
                        </Alert>
                      )}
                    </div>
                ...
                {ABTestManager.getAllTests().length === 0 && (
                  <div className="text-center py-8">
                    ...
                    <p className="text-sm text-gray-500">Interact with the examples above to generate test data</p>
                  </div>
                )}
              </div>
            </CardContent>
