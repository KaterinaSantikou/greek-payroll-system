  ...
  const handleEmailSubmit = async (data: EmailFormData) => {
    ...
    setTimeout(() => {
      ...
      if (emailDomain?.includes('gmail') || emailDomain?.includes('google')) {
        ...
        emailDomain?.includes('microsoft')
      ) {
      ...
      >
        <Card className="w-full max-w-md min-w-[480px] max-w-[560px] bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
          <CardHeader className="text-center">
            <div
              className={`w-16 h-16 rounded-full ${discoveredProvider.color} mx-auto mb-4 flex items-center justify-center text-2xl text-white`}
            >
            ...
            <CardDescription className="text-gray-600 dark:text-gray-400">
              We found your organization uses {discoveredProvider.name} for
              authentication
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="space-y-6">
            <Alert className="bg-blue-50 dark:bg-blue-900/20 border-blue-200 dark:border-blue-800">
              ...
              <AlertDescription className="text-blue-800 dark:text-blue-300">
                You'll be redirected to your organization's login page to sign
                in securely.
              </AlertDescription>
            </Alert>
            ...
            <div className="grid gap-2">
              {ssoProviders.map(provider => (
                <Button
                  ...
                  onClick={() => {
                    const email =
                      form.getValues('email') || 'user@' + provider.domain;
