      ...
      >
        <Card className="w-full max-w-md min-w-[480px] max-w-[560px] bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
          <CardHeader className="text-center">
            <Mail
              className="h-12 w-12 text-blue-500 dark:text-blue-400 mx-auto mb-4"
              aria-hidden="true"
            />
          ...
          <CardContent className="space-y-6">
            ...
            <Alert className="bg-blue-50 dark:bg-blue-900/20 border-blue-200 dark:border-blue-800">
              ...
              <AlertDescription className="text-blue-800 dark:text-blue-300">
                For security reasons, we'll always show this message regardless
                of whether the email address exists in our system.
              </AlertDescription>
            </Alert>
            ...
            <div className="space-y-3">
              <Button
                ...
                onClick={() =>
                  forgotPasswordMutation.mutate({ email: sentEmail })
                }
