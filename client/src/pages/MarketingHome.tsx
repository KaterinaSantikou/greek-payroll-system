...
const marketingContent = {
  seo: {
    title_en:
      'Next-Gen Greek Payroll — Digital Work Card, ERGANI II, APD/ΦΜΥ, Instant SEPA',
    title_el:
      'Επόμενης Γενιάς Μισθοδοσία — Ψηφιακή Κάρτα, ΕΡΓΑΝΗ ΙΙ, ΑΠΔ/ΦΜΥ, Άμεσα SEPA',
  },
  navbar: {
    links: [
    ...
    ctas: [
      {
        id: 'signup',
        label_en: 'Start free trial',
        label_el: 'Έναρξη δωρεάν δοκιμής',
        href: '/signup',
      },
      {
        id: 'demo',
        label_en: 'Book a demo',
        label_el: 'Κλείστε demo',
        href: '/contact',
      },
    ],
  },
  hero: {
    ...
    headline_el:
      'Μισθοδοσία σχεδιασμένη για την Ελλάδα. Γρήγορη. Συμμορφωμένη. Άμεση.',
    subhead_en:
      'Run payroll in minutes with Digital Work Card, ERGANI II, APD/ΦΜΥ automation and instant euro payouts.',
    subhead_el:
      'Ολοκληρώστε μισθοδοσία σε λίγα λεπτά με Ψηφιακή Κάρτα, ΕΡΓΑΝΗ ΙΙ, ΑΠΔ/ΦΜΥ και άμεσες πληρωμές σε ευρώ.',
  },
  socialProof: [
    {
      value: '99.5%',
      label_en: 'filing success (ERGANI/APD/ΦΜΥ)',
      label_el: 'επιτυχία δηλώσεων (ΕΡΓΑΝΗ/ΑΠΔ/ΦΜΥ)',
    },
    {
      value: '< 15 min',
      label_en: 'end-to-end payroll run',
      label_el: 'ολοκλήρωση μισθοδοσίας',
    },
    {
      value: '10s',
      label_en: 'instant payout target (SCT Inst)',
      label_el: 'στόχος άμεσης πληρωμής (SCT Inst)',
    },
  ],
  features: [
    {
      ...
      desc_en:
        'Live punches, exception workflows, and automatic ERGANI II events.',
      desc_el:
        'Ζωντανές καταγραφές, ροές εξαιρέσεων και αυτόματες δηλώσεις ΕΡΓΑΝΗ ΙΙ.',
    },
    {
      icon: FileCheck,
      ...
      desc_en:
        'Build, validate, submit and store receipts for e-EFKA/APD and AADE/FMY.',
      desc_el:
        'Δημιουργία, έλεγχος, υποβολή και αποθήκευση αποδεικτικών για e-ΕΦΚΑ/ΑΠΔ και ΑΑΔΕ/ΦΜΥ.',
    },
    {
      icon: Zap,
      ...
      desc_en:
        'Handle off-cycle fixes with instant euro transfers; auto-fallback to standard SCT.',
      desc_el:
        'Διαχειριστείτε διορθώσεις εκτός κύκλου με άμεσες μεταφορές ευρώ· αυτόματη εναλλακτική σε τυπικό SCT.',
    },
    {
      icon: BarChart3,
      ...
      desc_en:
        'Overtime, night/Sunday premiums, labor vs budget, tip pooling and more.',
      desc_el:
        'Υπερωρίες, νυχτερινά/Κυριακές, κόστος vs προϋπολογισμός, ταμείο φιλοδωρημάτων κ.ά.',
    },
    {
      icon: Lock,
      ...
      desc_en:
        'SOC-ready controls, MFA/SSO, audit logs, GDPR and pay-transparency support.',
      desc_el:
        'Έλεγχοι επιπέδου SOC, MFA/SSO, ημερολόγια ενεργειών, GDPR και υποστήριξη pay transparency.',
    },
    {
      icon: Puzzle,
      ...
      desc_en:
        'Native Xero/QBO connectors and a developer-grade GL API—no CSVs.',
      desc_el:
        'Έτοιμες συνδέσεις με Xero/QBO και GL API για προγραμματιστές—χωρίς CSV.',
    },
  ],
  pricing: {
    ...
    plans: [
      {
        ...
        features_en: [
          'Payroll runs',
          'Digital Work Card',
          'ERGANI/APD/ΦΜΥ exports',
        ],
        features_el: [
          'Κύκλοι μισθοδοσίας',
          'Ψηφιακή Κάρτα',
          'Εξαγωγές ΕΡΓΑΝΗ/ΑΠΔ/ΦΜΥ',
        ],
        cta: '/signup',
      },
      {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
              {t({
                hero: marketingContent.hero.headline_en,
                hero_el: marketingContent.hero.headline_el,
              })}
            </h1>
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              {t({
                sub: marketingContent.hero.subhead_en,
                sub_el: marketingContent.hero.subhead_el,
              })}
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <button className="flex items-center gap-2 text-gray-600 hover:text-gray-900">
                ...
                {t({
                  watch: 'Watch 2-min tour',
                  watch_el: 'Δείτε το 2-λεπτο βίντεο',
                })}
              </button>
            </div>
            ...
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                {t({
                  ...
                  security_el: 'Ασφάλεια & Εμπιστοσύνη',
                })}
              </h2>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-100 p-8 rounded-2xl">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">
                {t({
                  ...
                  trust_el: 'Ασφάλεια επιχειρηματικού επιπέδου',
                })}
              </h3>
              <p className="text-gray-600">
                {t({
                  ...
                  desc_el:
                    'Κατασκευασμένο με αρχές προτεραιότητας ασφάλειας και πλαίσια συμμόρφωσης που ικανοποιούν τα υψηλότερα πρότυπα για προστασία οικονομικών δεδομένων.',
                })}
              </p>
            </div>
          </div>
            ...
            {marketingContent.pricing.plans.map((plan, index) => (
              ...
              >
                ...
                <div className="text-3xl font-bold text-gray-900 mb-6">
                  {plan.price_en
                    ? t({ price: plan.price_en, price_el: plan.price_el! })
                    : plan.price}
                </div>
                  ...
                  {plan.features_en.map((feature, featureIndex) => (
                    <li key={featureIndex} className="flex items-center gap-3">
                      ...
                      <span className="text-gray-600">
                        {t({
                          feature,
                          feature_el: plan.features_el[featureIndex],
                        })}
                      </span>
                    </li>
                  ))}
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
            {t({
              ...
              ready_el:
                'Έτοιμοι να εκσυγχρονίσετε την ελληνική σας μισθοδοσία;',
            })}
          </h2>
          <p className="text-xl text-gray-600 mb-8">
            {t({
              contact_desc:
                'Join hundreds of Greek businesses who trust PayrollSync for their payroll needs.',
              contact_desc_el:
                'Συμμετέχετε σε εκατοντάδες ελληνικές επιχειρήσεις που εμπιστεύονται το PayrollSync για τις ανάγκες μισθοδοσίας τους.',
            })}
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              {t({
                ...
                start_el: 'Έναρξη δωρεάν δοκιμής',
              })}
              <ArrowRight className="w-5 h-5" />
            </Link>
            <Link
            ...
            >
              {t({
                ...
                schedule_el: 'Κλείστε μια επίδειξη',
              })}
            </Link>
          </div>
        </div>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400">
                {t({
                  footer:
                    'Modern payroll platform built specifically for Greek businesses.',
                  footer_el:
                    'Σύγχρονη πλατφόρμα μισθοδοσίας κατασκευασμένη ειδικά για ελληνικές επιχειρήσεις.',
                })}
              </p>
            </div>
            <div>
              <h4 className="font-semibold mb-4">
                {t({ product: 'Product', product_el: 'Προϊόν' })}
              </h4>
              <ul className="space-y-2 text-gray-400">
                <li>
                  ...
                  >
                    {t({ features: 'Features', features_el: 'Χαρακτηριστικά' })}
                  </a>
                </li>
                <li>
                  <a
                    ...
                    className="hover:text-white transition-colors"
                  >
                    {t({ pricing: 'Pricing', pricing_el: 'Τιμολόγηση' })}
                  </a>
                </li>
                <li>
                  <Link
                    ...
                    className="hover:text-white transition-colors"
                  >
                    {t({ security: 'Security', security_el: 'Ασφάλεια' })}
                  </Link>
                </li>
              </ul>
            </div>
            <div>
              <h4 className="font-semibold mb-4">
                {t({ company: 'Company', company_el: 'Εταιρεία' })}
              </h4>
              <ul className="space-y-2 text-gray-400">
                <li>
                  <Link
                    ...
                    className="hover:text-white transition-colors"
                  >
                    {t({ about: 'About', about_el: 'Σχετικά' })}
                  </Link>
                </li>
                <li>
                  <Link
                    ...
                    className="hover:text-white transition-colors"
                  >
                    {t({ contact: 'Contact', contact_el: 'Επικοινωνία' })}
                  </Link>
                </li>
                <li>
                  <a href="#" className="hover:text-white transition-colors">
                    {t({ support: 'Support', support_el: 'Υποστήριξη' })}
                  </a>
                </li>
              </ul>
            </div>
                ...
                <li>
                  <a href="#" className="hover:text-white transition-colors">
                    {t({
                      ...
                      privacy_el: 'Πολιτική Απορρήτου',
                    })}
                  </a>
                </li>
                <li>
                  <a href="#" className="hover:text-white transition-colors">
                    {t({ terms: 'Terms of Service', terms_el: 'Όροι Χρήσης' })}
                  </a>
                </li>
              </ul>
            </div>
          ...
          <div className="border-t border-gray-800 pt-8 mt-8 text-center text-gray-400">
            <p>
              &copy; 2025 PayrollSync.{' '}
              {t({
                rights: 'All rights reserved.',
                rights_el: 'Όλα τα δικαιώματα διατηρούνται.',
              })}
            </p>
          </div>
        </div>
