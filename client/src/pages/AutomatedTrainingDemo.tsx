  ...
  const translations = {
    en: {
      ...
      hero: {
        ...
        subtitle:
          'Revolutionary training system that creates personalized learning paths based on your role, experience level, and learning progress. Master complex Greek payroll processes through intelligent, adaptive education.',
      ...
      features: {
        ...
        personalized: {
          ...
          description:
            'AI creates custom learning journeys based on your role, experience, and progress patterns.',
        },
        adaptive: {
          title: 'Adaptive Content',
          description:
            'Training automatically adjusts difficulty and pace based on your learning performance.',
        },
        practical: {
          title: 'Practical Exercises',
          description:
            'Hands-on training with real Greek payroll scenarios and interactive simulations.',
        },
        certification: {
          title: 'Certification Ready',
          description:
            'Structured paths prepare you for Greek payroll certifications and professional recognition.',
        },
      },
      benefits: {
        ...
        efficiency: {
          ...
          description:
            'AI-driven personalization reduces training time by 60% while improving knowledge retention and practical application.',
        },
        compliance: {
          title: 'Always Current',
          description:
            'Content automatically updates with latest Greek regulations, ensuring your knowledge stays compliant and accurate.',
        },
        scalability: {
          title: 'Organization-Wide',
          description:
            'Scale training across your entire organization with role-based paths and progress tracking for every team member.',
        },
      },
      trainingAreas: {
      ...
      customization: {
        ...
        description:
          'Customize the demo to see how the training system adapts to different roles and experience levels.',
        role: 'Select Role',
    ...
    el: {
      ...
      subtitle:
        'Εξατομικευμένες Μαθησιακές Διαδρομές για Αριστεία στην Ελληνική Μισθοδοσία',
      hero: {
        title: 'Μάθηση με Τεχνητή Νοημοσύνη που Προσαρμόζεται σε Εσάς',
        subtitle:
          'Επαναστατικό σύστημα εκπαίδευσης που δημιουργεί εξατομικευμένες μαθησιακές διαδρομές βάσει του ρόλου, του επιπέδου εμπειρίας και της μαθησιακής προόδου σας. Κυριαρχήστε σε περίπλοκες ελληνικές διαδικασίες μισθοδοσίας μέσω έξυπνης, προσαρμοστικής εκπαίδευσης.',
      ...
      features: {
        ...
        personalized: {
          ...
          description:
            'Η AI δημιουργεί προσαρμοσμένα μαθησιακά ταξίδια βάσει του ρόλου, της εμπειρίας και των προτύπων προόδου σας.',
        },
        adaptive: {
          title: 'Προσαρμοστικό Περιεχόμενο',
          description:
            'Η εκπαίδευση προσαρμόζεται αυτόματα στη δυσκολία και τον ρυθμό βάσει της μαθησιακής σας απόδοσης.',
        },
        practical: {
          title: 'Πρακτικές Ασκήσεις',
          description:
            'Πρακτική εκπαίδευση με πραγματικά ελληνικά σενάρια μισθοδοσίας και διαδραστικές προσομοιώσεις.',
        },
        certification: {
          title: 'Έτοιμο για Πιστοποίηση',
          description:
            'Δομημένες διαδρομές σας προετοιμάζουν για πιστοποιήσεις ελληνικής μισθοδοσίας και επαγγελματική αναγνώριση.',
        },
      },
      benefits: {
        title:
          'Γιατί η Αυτοματοποιημένη Εκπαίδευση Επαναστατεί την Ελληνική Εκπαίδευση Μισθοδοσίας',
        efficiency: {
          title: 'Επιταχυνόμενη Μάθηση',
          description:
            'Η εξατομίκευση με AI μειώνει τον χρόνο εκπαίδευσης κατά 60% βελτιώνοντας παράλληλα τη διατήρηση γνώσεων και την πρακτική εφαρμογή.',
        },
        compliance: {
          title: 'Πάντα Ενημερωμένο',
          description:
            'Το περιεχόμενο ενημερώνεται αυτόματα με τους τελευταίους ελληνικούς κανονισμούς, διασφαλίζοντας ότι οι γνώσεις σας παραμένουν συμβατές και ακριβείς.',
        },
        scalability: {
          title: 'Σε Όλο τον Οργανισμό',
          description:
            'Κλιμάκωση εκπαίδευσης σε όλο τον οργανισμό με διαδρομές βάσει ρόλων και παρακολούθηση προόδου για κάθε μέλος της ομάδας.',
        },
      },
      trainingAreas: {
      ...
      customization: {
        ...
        description:
          'Προσαρμόστε την επίδειξη για να δείτε πώς το σύστημα εκπαίδευσης προσαρμόζεται σε διαφορετικούς ρόλους και επίπεδα εμπειρίας.',
        role: 'Επιλογή Ρόλου',
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div id="features" className="mb-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center p-8 bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 leading-relaxed">
                {t.features.certification.description}
              </p>
            </div>
          </div>
        </div>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-medium text-sm">
                      {
                        t.trainingAreas[
                          area.key as keyof typeof t.trainingAreas
                        ]
                      }
                    </span>
                  </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {learningFormats.map((format, index) => {
              ...
              return (
                ...
                >
                  <div
                    className={`w-12 h-12 ${format.color} rounded-lg flex items-center justify-center mx-auto mb-4`}
                  >
                  ...
                  <h3 className="font-semibold mb-2">
                    {
                      t.learningFormats[
                        format.key as keyof typeof t.learningFormats
                      ]
                    }
                  </h3>
                </div>
        ...
        <div className="bg-gradient-to-r from-purple-600 to-blue-600 text-white text-center rounded-2xl p-12">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8 max-w-md mx-auto">
            <div>
              <label className="block text-left text-purple-100 mb-2 font-medium">
                {t.customization.role}
              </label>
            ...
            <div>
              <label className="block text-left text-purple-100 mb-2 font-medium">
                {t.customization.experience}
              </label>
              <Select
                value={selectedExperience}
                onValueChange={value => setSelectedExperience(value as any)}
              >
                <SelectTrigger className="bg-white text-gray-900">
                  <SelectValue />
                </SelectTrigger>
