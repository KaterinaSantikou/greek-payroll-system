...
export default function TaxLawAlertsDemo({ locale = 'en' }: DemoProps) {
  ...
  const translations = {
    en: {
      ...
      hero: {
        ...
        subtitle: 'Comprehensive monitoring system that tracks all Greek tax and labor law modifications, providing instant alerts and compliance guidance to ensure your organization stays current with the latest regulatory requirements.',
      ...
      features: {
        ...
        realTimeMonitoring: {
          ...
          description: 'Continuous tracking of Greek tax law changes from official sources including Ministry of Finance, AADE, and EFKA.'
        },
        instantAlerts: {
          title: 'Instant Alerts',
          description: 'Immediate notifications for critical tax law changes with impact assessment and required compliance actions.'
        },
        complianceGuidance: {
          title: 'Compliance Guidance',
          description: 'Step-by-step compliance instructions and automated task creation to ensure timely implementation.'
        },
        impactAssessment: {
          title: 'Impact Assessment',
          description: 'Intelligent analysis of how tax law changes affect your organization, employees, and compliance obligations.'
        }
      },
      benefits: {
        ...
        proactiveCompliance: {
          ...
          description: 'Stay ahead of tax law changes with advance notifications and automated compliance task generation.'
        },
        riskMitigation: {
          title: 'Risk Mitigation',
          description: 'Prevent costly penalties and violations through immediate awareness of critical regulatory changes.'
        },
        operationalEfficiency: {
          title: 'Operational Efficiency',
          description: 'Reduce compliance workload by 70% with automated monitoring, categorization, and task assignment.'
        }
      },
      categories: {
    ...
    el: {
      ...
      hero: {
        title: 'Μη Χάσετε Ποτέ Κρίσιμες Αλλαγές των Ελληνικών Φορολογικών Νόμων',
        subtitle: 'Περιεκτικό σύστημα παρακολούθησης που εντοπίζει όλες τις τροποποιήσεις των ελληνικών φορολογικών και εργατικών νόμων, παρέχοντας άμεσες ειδοποιήσεις και οδηγίες συμμόρφωσης για να διασφαλίζει ότι ο οργανισμός σας παραμένει ενημερωμένος με τις τελευταίες κανονιστικές απαιτήσεις.',
      ...
      features: {
        ...
        realTimeMonitoring: {
          ...
          description: 'Συνεχής παρακολούθηση αλλαγών ελληνικών φορολογικών νόμων από επίσημες πηγές συμπεριλαμβανομένου του Υπουργείου Οικονομικών, ΑΑΔΕ και e-ΕΦΚΑ.'
        },
        instantAlerts: {
          title: 'Άμεσες Ειδοποιήσεις',
          description: 'Άμεσες ειδοποιήσεις για κρίσιμες αλλαγές φορολογικών νόμων με αξιολόγηση επιπτώσεων και απαιτούμενες ενέργειες συμμόρφωσης.'
        },
        complianceGuidance: {
          title: 'Οδηγίες Συμμόρφωσης',
          description: 'Βήμα προς βήμα οδηγίες συμμόρφωσης και αυτοματοποιημένη δημιουργία εργασιών για διασφάλιση έγκαιρης υλοποίησης.'
        },
        impactAssessment: {
          title: 'Αξιολόγηση Επιπτώσεων',
          description: 'Έξυπνη ανάλυση του πώς οι αλλαγές φορολογικών νόμων επηρεάζουν τον οργανισμό σας, τους εργαζομένους και τις υποχρεώσεις συμμόρφωσης.'
        }
      },
      benefits: {
        title: 'Γιατί οι Ειδοποιήσεις Φορολογικών Νόμων Μεταμορφώνουν τη Συμμόρφωση',
        proactiveCompliance: {
          title: 'Προληπτική Συμμόρφωση',
          description: 'Προηγηθείτε των αλλαγών φορολογικών νόμων με προκαταρκτικές ειδοποιήσεις και αυτοματοποιημένη δημιουργία εργασιών συμμόρφωσης.'
        },
        riskMitigation: {
          title: 'Μείωση Κινδύνων',
          description: 'Αποτρέψτε κοστοβόρα πρόστιμα και παραβάσεις μέσω άμεσης ενημέρωσης για κρίσιμες κανονιστικές αλλαγές.'
        },
        operationalEfficiency: {
          title: 'Λειτουργική Αποδοτικότητα',
          description: 'Μειώστε τον φόρτο εργασίας συμμόρφωσης κατά 70% με αυτοματοποιημένη παρακολούθηση, κατηγοριοποίηση και ανάθεση εργασιών.'
        }
      },
      categories: {
  ...
  const performanceMetrics = [
    { key: 'changesTracked', value: '328', icon: FileText, color: 'text-blue-600' },
    { key: 'alertSpeed', value: '<5 min', icon: Zap, color: 'text-green-600' },
    { key: 'complianceRate', value: '94.2%', icon: CheckCircle, color: 'text-emerald-600' },
    { key: 'accuracyRate', value: '99.1%', icon: Target, color: 'text-purple-600' }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-red-50">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div id="features" className="mb-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center p-8 bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-semibold mb-4">{t.features.instantAlerts.title}</h3>
              <p className="text-gray-600 leading-relaxed">{t.features.instantAlerts.description}</p>
            </div>
            ...
            <div className="text-center p-8 bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-semibold mb-4">{t.features.complianceGuidance.title}</h3>
              <p className="text-gray-600 leading-relaxed">{t.features.complianceGuidance.description}</p>
            </div>
            ...
            <div className="text-center p-8 bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-semibold mb-4">{t.features.impactAssessment.title}</h3>
              <p className="text-gray-600 leading-relaxed">{t.features.impactAssessment.description}</p>
            </div>
          </div>
        </div>
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-8 bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-semibold mb-4">{t.benefits.proactiveCompliance.title}</h3>
              <p className="text-gray-600 leading-relaxed">{t.benefits.proactiveCompliance.description}</p>
            </div>
        ...
        <div className="bg-gradient-to-r from-orange-600 to-red-600 text-white text-center rounded-2xl p-12">
          <h2 className="text-3xl font-bold mb-4">Stay Compliant with Every Greek Tax Change</h2>
          <p className="text-xl text-orange-100 mb-8 max-w-2xl mx-auto">
            Transform your tax compliance with intelligent monitoring that ensures immediate awareness of all Greek tax law modifications and automated compliance guidance.
          </p>
