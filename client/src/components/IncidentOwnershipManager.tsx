...
export function IncidentOwnershipManager() {
  ...
  const loadStatistics = async () => {
    try {
      const response = await apiRequest('GET', '/api/incident-ownership/statistics');
      if (response.ok) {
  ...
  const registerResponder = async () => {
    ...
    try {
      const response = await apiRequest('POST', '/api/incident-ownership/responders', {
  ...
  const testAutoAssignment = async () => {
    try {
      ...
      const response = await apiRequest('POST', `/api/incident-ownership/assign/${incidentId}`, {
        severity: testIncident.severity,
        type: testIncident.type,
        requiredSkills: testIncident.requiredSkills.filter(skill => skill.trim())
      });
      ...
      if (response.ok) {
        ...
        toast({
          ...
          variant: data.assignment.assignmentType === 'fallback_assigned' ? 'destructive' : 'default'
        });
        loadStatistics();
      } else {
        const errorData = await response.json();
  ...
  const getFallbackActions = async () => {
    try {
      ...
      const response = await apiRequest('GET', `/api/incident-ownership/fallback-actions/${incidentId}`);
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-semibold">Incident Ownership Management</h2>
          <p className="text-sm text-muted-foreground">
            Handle incident assignment when no named owners or escalation matrix exists
          </p>
        </div>
        <div className="flex items-center space-x-2">
          ...
          <Badge variant="outline" className="flex items-center space-x-1">
            ...
            <span>{Math.round(statistics.averageResponseTime)}m Avg Response</span>
          </Badge>
        </div>
      </div>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        <TabsList>
          ...
          <TabsTrigger value="responders" className="flex items-center space-x-1">
        ...
        <TabsContent value="overview" className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">{statistics.autoAssignments}</div>
                <p className="text-xs text-muted-foreground">
                  {statistics.totalAssignments > 0 
                    ? Math.round((statistics.autoAssignments / statistics.totalAssignments) * 100)
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium">Fallback Assignments</CardTitle>
                <Shield className="h-4 w-4 text-muted-foreground" />
              </CardHeader>
              <CardContent>
                <div className="text-2xl font-bold">{statistics.fallbackAssignments}</div>
                <p className="text-xs text-muted-foreground">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">{statistics.escalations}</div>
                <p className="text-xs text-muted-foreground">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <Alert>
                ...
                <AlertDescription>
                  <strong>No Named Incident Owners:</strong> System is operating in fallback mode. 
                  All incidents will be automatically assigned to available responders or fallback pool.
                </AlertDescription>
              </Alert>
              ...
              <Alert>
                ...
                <AlertDescription>
                  <strong>No Escalation Matrix:</strong> Using automatic escalation based on responder 
                  levels and availability. Fallback procedures activated for critical situations.
                </AlertDescription>
              </Alert>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setNewResponder(prev => ({ ...prev, email: e.target.value }))}
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Select 
                    ...
                    onValueChange={(value) => setNewResponder(prev => ({ ...prev, responderType: value }))}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                ...
                <div className="space-y-2">
                  ...
                  <Select 
                    ...
                    onValueChange={(value) => setNewResponder(prev => ({ ...prev, escalationLevel: parseInt(value) }))}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                ...
                <div className="space-y-2">
                  ...
                  <Select 
                    ...
                    onValueChange={(value) => setNewResponder(prev => ({ ...prev, timezone: value }))}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-center py-8 text-muted-foreground">
                ...
                <p className="text-sm">Register responders above to enable automatic assignment</p>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Select 
                    ...
                    onValueChange={(value) => setTestIncident(prev => ({ ...prev, severity: value }))}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                ...
                <div className="space-y-2">
                  ...
                  <Select 
                    ...
                    onValueChange={(value) => setTestIncident(prev => ({ ...prev, type: value }))}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
                      ...
                      <SelectItem value="network_problem">Network Problem</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
              </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Button type="button" variant="outline" size="sm" onClick={addTestSkill}>
                    <UserPlus className="h-3 w-3 mr-1" />
                    Add Skill
                  </Button>
                </div>
              ...
              <div className="flex space-x-2">
                ...
                <Button onClick={getFallbackActions} variant="outline" className="flex-1">
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-3">
                  <h4 className="font-medium text-sm">Auto-Assignment Process</h4>
