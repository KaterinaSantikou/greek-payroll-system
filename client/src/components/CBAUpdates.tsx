...
const CBA_UPDATES: CBAUpdate[] = [
  {
    ...
    description:
      'Minimum wage increased from €740 to €760 effective January 1, 2025',
    descriptionEl:
      'Κατώτατος μισθός αυξήθηκε από €740 σε €760 με ισχύ από 1 Ιανουαρίου 2025',
  ...
  },
  {
    ...
    description:
      'Tips distribution method updated to include digital payment processing',
    descriptionEl:
      'Ενημερώθηκε η μέθοδος διανομής φιλοδωρημάτων για να συμπεριλάβει την ψηφιακή επεξεργασία πληρωμών',
  ...
  },
  {
    ...
    descriptionEl:
      'Νέα πολιτική υβριδικής εργασίας και επιδόματα για τον τραπεζικό τομέα',
...
export default function CBAUpdates({ locale = 'en' }: CBAUpdatesProps) {
  ...
  const filteredAgreements = agreements.filter(agreement => {
    const sectorMatch =
      selectedSector === 'all' ||
      agreement.sector.toLowerCase() === selectedSector;
    const statusMatch =
      selectedStatus === 'all' || agreement.status === selectedStatus;
    const searchMatch =
      searchTerm === '' ||
  ...
  const handleReviewUpdate = (updateId: string) => {
    setUpdates(prev =>
      prev.map(update =>
        update.id === updateId ? { ...update, status: 'reviewing' } : update
      )
    );
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 xl:grid-cols-8 gap-4 mb-6">
            <Card className="p-4 bg-gradient-to-r from-blue-500 to-blue-600 text-white">
              <div className="text-center">
                <div className="text-2xl font-bold">
                  {CBA_METRICS.totalAgreements}
                </div>
                <div className="text-xs text-blue-100">
                  {t.metrics.totalAgreements}
                </div>
              </div>
            </Card>
            ...
            <Card className="p-4 bg-gradient-to-r from-green-500 to-green-600 text-white">
              <div className="text-center">
                <div className="text-2xl font-bold">
                  {CBA_METRICS.activeAgreements}
                </div>
                <div className="text-xs text-green-100">
                  {t.metrics.activeAgreements}
                </div>
              </div>
            </Card>
            ...
            <Card className="p-4 bg-gradient-to-r from-yellow-500 to-yellow-600 text-white">
              <div className="text-center">
                <div className="text-2xl font-bold">
                  {CBA_METRICS.pendingUpdates}
                </div>
                <div className="text-xs text-yellow-100">
                  {t.metrics.pendingUpdates}
                </div>
              </div>
            </Card>
            ...
            <Card className="p-4 bg-gradient-to-r from-red-500 to-red-600 text-white">
              <div className="text-center">
                <div className="text-2xl font-bold">
                  {CBA_METRICS.criticalUpdates}
                </div>
                <div className="text-xs text-red-100">
                  {t.metrics.criticalUpdates}
                </div>
              </div>
            </Card>
            ...
            <Card className="p-4 bg-gradient-to-r from-indigo-500 to-indigo-600 text-white">
              <div className="text-center">
                <div className="text-2xl font-bold">
                  {(CBA_METRICS.employeesCovered / 1000000).toFixed(1)}M
                </div>
                <div className="text-xs text-indigo-100">
                  {t.metrics.employeesCovered}
                </div>
              </div>
            </Card>
            ...
            <Card className="p-4 bg-gradient-to-r from-teal-500 to-teal-600 text-white">
              <div className="text-center">
                <div className="text-2xl font-bold">
                  {CBA_METRICS.sectorsTracked}
                </div>
                <div className="text-xs text-teal-100">
                  {t.metrics.sectorsTracked}
                </div>
              </div>
            </Card>
            ...
            <Card className="p-4 bg-gradient-to-r from-emerald-500 to-emerald-600 text-white">
              <div className="text-center">
                <div className="text-2xl font-bold">
                  {CBA_METRICS.autoAppliedUpdates}
                </div>
                <div className="text-xs text-emerald-100">
                  {t.metrics.autoAppliedUpdates}
                </div>
              </div>
            </Card>
          </div>
                      ...
                      {updates
                        .filter(update =>
                          updates.find(
                            u =>
                              u.id === update.id &&
                              agreements.find(a => a.id === update.cbaId)
                                ?.impactLevel === 'critical'
                          )
                        )
                        .map(update => {
                          const cba = agreements.find(
                            a => a.id === update.cbaId
                          );
                              ...
                              <div className="flex items-center gap-4">
                                ...
                                <div>
                                  ...
                                  <div className="text-sm text-gray-600">
                                    {locale === 'en'
                                      ? update.description
                                      : update.descriptionEl}
                                  </div>
                                  <div className="text-xs text-red-600 mt-1">
                                    Effective: {update.effectiveDate} • Affects{' '}
                                    {update.impactedEmployees.toLocaleString()}{' '}
                                    employees
                                  </div>
                                </div>
                              </div>
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-start justify-between mb-4">
                          ...
                          <div>
                            ...
                            <p className="text-gray-600 text-sm mb-2">
                              {locale === 'en'
                                ? agreement.sector
                                : agreement.sectorEl}{' '}
                              • Code: {agreement.code} • Covers{' '}
                              {agreement.coverageEmployees.toLocaleString()}{' '}
                              employees
                            </p>
                        ...
                        <div className="flex items-center gap-3">
                          <Badge className={getStatusColor(agreement.status)}>
                            {
                              t.status[
                                agreement.status as keyof typeof t.status
                              ]
                            }
                          </Badge>
                          <Badge
                            className={`${getImpactColor(agreement.impactLevel)} border-current`}
                            variant="outline"
                          >
                            {
                              t.impactLevels[
                                agreement.impactLevel as keyof typeof t.impactLevels
                              ]
                            }
                          </Badge>
                        </div>
                      ...
                      <div className="grid md:grid-cols-3 gap-4 mb-4">
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-2">
                            <Progress
                              value={agreement.complianceScore}
                              className="flex-1"
                            />
                            <span className="text-sm font-medium">
                              {agreement.complianceScore}%
                            </span>
                          </div>
                        </div>
                      ...
                      <div className="mb-4">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {(locale === 'en'
                            ? agreement.keyChanges
                            : agreement.keyChangesEl
                          )
                            .slice(0, 3)
                            .map((change, index) => (
                              <Badge
                      ...
                      <div className="flex items-center justify-between">
                        <div className="text-sm text-gray-600">
                          Published by:{' '}
                          {locale === 'en'
                            ? agreement.publishedBy
                            : agreement.publishedByEl}
                        </div>
                        <div className="flex items-center gap-2">
                        ...
                        <div className="flex items-start justify-between mb-3">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <Badge variant="outline">
                              {locale === 'en'
                                ? t.updateTypes[
                                    update.updateType as keyof typeof t.updateTypes
                                  ]
                                : update.updateTypeEl}
                            </Badge>
                          </div>
                ...
                <div className="space-y-4">
                  <div className="p-4 border-l-4 border-red-500 bg-red-50 rounded">
                    ...
                    <p className="text-sm text-red-700">
                      {t.notifications.criticalUpdate}: National General CBA
                  ...
                  <div className="p-4 border-l-4 border-green-500 bg-green-50 rounded">
                    ...
                    <p className="text-sm text-green-700">
                      {t.notifications.autoApplied}: Retail sector Sunday work
                      premium increased to 75%.
                    </p>
                  </div>
                  ...
                  <div className="p-4 border-l-4 border-blue-500 bg-blue-50 rounded">
                    ...
                    <p className="text-sm text-blue-700">
                      {t.notifications.newAgreement}: Banking sector collective
                      agreement for 2024-2025 published.
                    </p>
                  </div>
                  ...
                  <div className="p-4 border-l-4 border-yellow-500 bg-yellow-50 rounded">
                    ...
                    <p className="text-sm text-yellow-700">
                      {t.notifications.expiringAgreement}: Manufacturing sector
                      CBA expires on February 28, 2025.
                    </p>
                  </div>
                </div>
              </CardContent>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-center mb-6">
                    ...
                    <Progress
                      value={CBA_METRICS.complianceRate}
                      className="w-full"
                    />
                  </div>
                  <div className="space-y-3">
                    <div className="flex justify-between">
                      <span className="text-sm text-gray-600">
                        {t.compliance.sectorsCompliant}
                      </span>
                      <span className="text-sm font-medium">13 of 15</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-sm text-gray-600">
                        {t.compliance.pendingActions}
                      </span>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          Receive email alerts for critical CBA updates
                        </p>
                      </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          Automatically apply updates with low to medium impact
                        </p>
                      </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          Receive weekly summary of CBA compliance status
                        </p>
                      </div>
                      <Button variant="default" size="sm">
                        Enabled
