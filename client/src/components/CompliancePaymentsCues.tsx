    ...
    <div className="space-y-4">
      ...
      {shouldShowPayrollCue && (
        <Alert className={cn(
          ...
          payrollCue.isOverdue && "border-red-200 bg-red-50 dark:border-red-800 dark:bg-red-950"
        )}>
          ...
          <AlertTitle className={cn(
            payrollCue.isOverdue ? "text-red-800 dark:text-red-200" : "text-amber-800 dark:text-amber-200"
          )}>
            {payrollCue.isOverdue ? "Εκκρεμής Μισθοδοσία" : "Επερχόμενη Μισθοδοσία"}
          </AlertTitle>
          <AlertDescription className={cn(
            "flex items-center justify-between",
            payrollCue.isOverdue ? "text-red-700 dark:text-red-300" : "text-amber-700 dark:text-amber-300"
          )}>
            <div>
