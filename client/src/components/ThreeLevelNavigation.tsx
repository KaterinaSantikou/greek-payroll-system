        ...
        items: [
          {
            ...
            description: 'Real-time punch tracking',
          },
          {
            name: 'Exceptions',
            href: '/advanced-time-capture',
            description: 'Missing & invalid punches',
          },
          {
            name: 'Corrections',
            href: '/manager-workflows',
            description: 'Time correction approvals',
          },
        ],
      },
      {
        ...
        items: [
          {
            name: 'Publish',
            href: '/schedules',
            description: 'Schedule publication & distribution',
          },
          {
            name: 'Change Log',
            href: '/analytics',
            description: 'Schedule modification history',
          },
          {
            name: 'ERGANI Actions',
            href: '/ergani-compliance',
            description: 'Ministry notification queue',
          },
        ],
      },
    ],
    ...
    items: [
      {
        ...
        items: [
          ...
          {
            name: 'Advanced Time Capture',
            href: '/advanced-time-capture',
            description: 'Multi-method clock-in',
          },
        ],
      },
      {
        ...
        items: [
          {
            name: 'ERGANI II Compliance',
            href: '/ergani-compliance',
            description: 'Ministry reporting',
          },
          {
        ...
        items: [
          {
            name: 'KPI Dashboard',
            href: '/kpi-dashboard',
            description: 'Critical 2025 success metrics',
          },
          {
            name: 'Success Metrics',
            href: '/success-metrics',
            description: 'Detailed KPI tracking',
          },
        ],
      },
      {
        ...
        items: [
          ...
          },
          {
            name: 'Forecasting',
            href: '/forecasting',
            description: 'AI-driven workforce planning',
          },
        ],
      },
      {
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            description: 'Complete Greek payroll workflow',
          },
          {
            name: 'Earnings Codes',
            href: '/earnings-codes',
            description: 'REG & NIGHT_25 standardized system',
          },
        ],
      },
    ],
    ...
    items: [
      {
        ...
        items: [
          ...
          },
          {
            name: 'Contracts',
            href: '/employees',
            description: 'Employment contracts & terms',
          },
          {
            name: 'Documents',
            href: '/legal',
          ...
          },
          {
            name: 'Assignments',
            href: '/allowances',
            description: 'Role & department assignments',
          },
        ],
      },
      {
        ...
        items: [
          {
            name: 'Builder',
            href: '/schedules',
            description: 'Schedule creation tools',
          },
          {
            name: 'Templates',
            href: '/leave',
            description: 'Reusable schedule patterns',
          },
          {
            name: 'Approvals',
            href: '/manager-workflows',
            description: 'Schedule approval workflows',
          },
        ],
      },
    ],
        ...
        items: [
          {
            name: 'Draft',
            href: '/payroll',
            description: 'Initial payroll calculations',
          },
          {
            name: 'Validate',
            href: '/modern-payroll',
            description: 'Compliance & accuracy checks',
          },
          {
            name: 'Finalize',
            href: '/payments',
            description: 'Lock & distribute payroll',
          },
          {
            name: 'Post-Run Audit',
            href: '/analytics',
        ...
        items: [
          {
            name: 'Earnings',
            href: '/allowances',
            description: 'Basic pay & overtime',
          },
          {
            name: 'Deductions',
            href: '/compliance',
          ...
          },
          {
            name: 'Rates',
            href: '/overtime',
            description: 'Hourly & premium rates',
          },
          {
        ...
        items: [
          {
            name: 'Δώρο Πάσχα',
            href: '/payroll-integration',
            description: 'Easter bonus calculation',
          },
          {
            name: 'Χριστουγέννων',
            href: '/manager-workflows',
            description: 'Christmas bonus calculation',
          },
          {
            name: 'Επίδομα Άδειας',
            href: '/leave',
            description: 'Vacation allowance calculation',
          },
        ],
      },
    ],
        ...
        items: [
          {
            name: 'Create SEPA',
            href: '/payments',
            description: 'SEPA Direct Debit file generation',
          },
          {
            name: 'Approvals',
            href: '/manager-workflows',
          ...
          },
          {
            name: 'Bank Receipts',
            href: '/analytics',
            description: 'Bank confirmation processing',
          },
        ],
      },
      {
        ...
        items: [
          {
            name: 'Urgent',
            href: '/overtime',
            description: 'Emergency payment processing',
          },
          {
            name: 'Corrections',
            href: '/compliance',
            description: 'Payroll error corrections',
          },
          {
            name: 'Reversals',
            href: '/payroll-integration',
    ...
    items: [
      {
        ...
        items: [
          ...
          },
          {
            name: 'Preview',
            href: '/analytics',
            description: 'Journal entry preview',
          },
          {
            name: 'Post',
            href: '/payments',
            description: 'GL posting execution',
          },
        ],
      },
      {
        ...
        items: [
          {
            name: 'Payroll vs GL',
            href: '/modern-payroll',
            description: 'Payroll to GL reconciliation',
          },
          {
            name: 'Variances',
            href: '/compliance',
            description: 'Variance analysis & resolution',
          },
        ],
      },
    ],
        ...
        items: [
          {
            name: 'Hires',
            href: '/employee-master',
            description: 'New employee notifications',
          },
          {
            name: 'Schedules',
            href: '/schedules',
            description: 'Work schedule submissions',
          },
          {
            name: 'OT',
            href: '/overtime',
          ...
          },
          {
            name: 'Terminations',
            href: '/employees',
            description: 'Employee departure forms',
          },
          {
            name: 'Receipts',
            href: '/ergani-compliance',
            description: 'Submission confirmations',
          },
        ],
      },
      {
        ...
        items: [
          {
            name: 'Build',
            href: '/payroll',
            description: 'Insurance contribution files',
          },
          {
            name: 'Validate',
            href: '/compliance',
          ...
          },
          {
            name: 'Submit',
            href: '/payroll-integration',
            description: 'Electronic submission',
          },
          {
            name: 'Receipts',
            href: '/analytics',
            description: 'Confirmation receipts',
          },
        ],
      },
      {
        ...
        items: [
          {
            name: 'Build File',
            href: '/payments',
            description: 'Payroll tax file generation',
          },
          {
            name: 'Merge',
            href: '/modern-payroll',
          ...
          },
          {
            name: 'Submit',
            href: '/legal',
            description: 'Tax authority submission',
          },
          {
            name: 'Payment',
            href: '/manager-workflows',
            description: 'Tax payment processing',
          },
        ],
      },
    ],
        ...
        items: [
          {
            name: 'Hotel Operations',
            href: '/hotel-operations',
            description: 'Multi-property tools',
          },
          {
          ...
          },
          {
            ...
            description: 'POS revenue allocation & distribution',
          },
        ],
      },
      {
        ...
        items: [
          {
            name: 'Overtime',
            href: '/overtime',
            description: 'Overtime policy configuration',
          },
          {
            name: 'Night',
            href: '/schedules',
            description: 'Night shift premium rules',
          },
          {
            name: 'Sunday/Holiday',
            href: '/leave',
            description: 'Weekend & holiday rates',
          },
          {
            name: 'Breaks',
            href: '/advanced-time-capture',
            description: 'Break time policies',
          },
          {
            name: 'Tips',
            href: '/hotel-operations',
            description: 'Tip pooling & distribution',
          },
        ],
      },
      {
        ...
        items: [
          {
            name: 'Minimum Wage Tables',
            href: '/compliance',
            description: 'Greek minimum wage rates',
          },
          {
            name: 'Effective-Date Rules',
            href: '/legal',
            description: 'Policy effective date management',
          },
        ],
      },
      {
        ...
        items: [
          {
            name: 'ERGANI',
            href: '/ergani-compliance',
            description: 'Ministry of Labor connection',
          },
          {
            name: 'EFKA',
            href: '/payroll-integration',
            description: 'Social security integration',
          },
          {
            name: 'AADE',
            href: '/payments',
            description: 'Tax authority connection',
          },
          {
            name: 'Banks',
            href: '/analytics',
            description: 'Banking system integrations',
          },
          {
            name: 'ERP',
            href: '/modern-payroll',
            description: 'Enterprise system connectors',
          },
          {
            name: 'SSO',
            href: '/manager-workflows',
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        items: [
          {
            name: 'Change Log & Legal Watch',
            href: '/changelog-legal-watch',
            description: 'Versioned rule packs & legal monitoring',
          },
          {
            name: 'Document AI',
            href: '/document-ai',
        ...
        items: [
          {
            name: 'S1 Dashboard',
            href: '/s1-dashboard',
            description: 'ESRS S1 sustainability metrics overview',
          },
          {
            name: 'S1 Metrics',
            href: '/s1-metrics',
            description: 'Detailed S1 calculations and reporting',
          },
          {
            name: 'S1 Acceptance Testing',
            href: '/s1-acceptance-testing',
            description: 'Validate dev ticket acceptance criteria',
          },
        ],
      },
    ],
