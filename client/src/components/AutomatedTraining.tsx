...
const TRAINING_MODULES: TrainingModule[] = [
  // Greek Payroll Fundamentals
  {
    ...
    description:
      'Comprehensive overview of Greek payroll system, laws, and regulations',
    descriptionEl:
      'Πλήρης επισκόπηση του ελληνικού συστήματος μισθοδοσίας, νόμων και κανονισμών',
    difficulty: 'beginner',
    duration: 45,
    type: 'video',
  ...
  },
  {
    ...
    description:
      'Complete guide to ERGANI II system, digital work cards, and compliance',
    descriptionEl:
      'Πλήρης οδηγός για το σύστημα ΕΡΓΑΝΗ ΙΙ, ψηφιακές κάρτες εργασίας και συμμόρφωση',
  ...
  },
  {
    ...
    description:
      'Master e-EFKA insurance calculations, reporting, and compliance requirements',
    descriptionEl:
      'Κυριαρχήστε στους υπολογισμούς ασφάλισης e-ΕΦΚΑ, αναφορές και απαιτήσεις συμμόρφωσης',
    difficulty: 'intermediate',
    duration: 75,
    type: 'practical',
    category: 'Compliance',
  ...
  },
  {
    ...
    description:
      'Learn AADE integration, tax calculations, and automated filing processes',
    descriptionEl:
      'Μάθετε την ενσωμάτωση ΑΑΔΕ, φορολογικούς υπολογισμούς και αυτοματοποιημένες διαδικασίες υποβολής',
    difficulty: 'advanced',
    duration: 90,
    type: 'interactive',
    category: 'Compliance',
  ...
  },
  {
    ...
    description:
      'Configure SEPA payments, Greek bank integration, and automated salary transfers',
    descriptionEl:
      'Ρύθμιση πληρωμών SEPA, ενσωμάτωση ελληνικής τράπεζας και αυτοματοποιημένες μεταφορές μισθών',
    difficulty: 'intermediate',
    duration: 50,
    type: 'practical',
    category: 'Banking',
  ...
  },
  {
    ...
    description:
      'Understanding and implementing Greek collective labor agreements in payroll',
    descriptionEl:
      'Κατανόηση και εφαρμογή ελληνικών συλλογικών εργατικών συμβάσεων στη μισθοδοσία',
    difficulty: 'advanced',
    duration: 120,
    type: 'reading',
    category: 'Legal',
  ...
  },
  {
    ...
    description:
      'Master complex Greek payroll calculations including overtime, bonuses, and deductions',
    descriptionEl:
      'Κυριαρχήστε στους περίπλοκους υπολογισμούς ελληνικής μισθοδοσίας συμπεριλαμβανομένων υπερωριών, μπόνους και κρατήσεων',
    difficulty: 'advanced',
    duration: 100,
    type: 'interactive',
  ...
  },
  {
    ...
    description:
      'Specialized training for hotel industry payroll including tips, seasonal work, and split shifts',
    descriptionEl:
      'Εξειδικευμένη εκπαίδευση για μισθοδοσία ξενοδοχειακής βιομηχανίας συμπεριλαμβανομένων φιλοδωρημάτων, εποχιακής εργασίας και διαχωρισμένων βαρδιών',
    difficulty: 'advanced',
    duration: 85,
    type: 'practical',
...
const LEARNING_PATHS: LearningPath[] = [
  {
    ...
    description:
      'Complete learning path for HR professionals managing Greek payroll',
    descriptionEl:
      'Πλήρης μαθησιακή διαδρομή για επαγγελματίες HR που διαχειρίζονται ελληνική μισθοδοσία',
  ...
  },
  {
    ...
    description:
      'Essential Greek payroll knowledge for managers and supervisors',
    descriptionEl:
      'Βασικές γνώσεις ελληνικής μισθοδοσίας για μάνατζερ και επιβλέποντες',
    role: 'Manager',
    roleEl: 'Μάνατζερ',
    modules: [
      'greek-payroll-intro',
  ...
  },
  {
    ...
    descriptionEl:
      'Εξειδικευμένη διαδρομή για μισθοδοσία ξενοδοχειακής και φιλοξενίας βιομηχανίας',
...
export default function AutomatedTraining({
  ...
  const translations = {
    ...
    el: {
      ...
      subtitle:
        'Εξατομικευμένες Μαθησιακές Διαδρομές για Κυριαρχία στην Ελληνική Μισθοδοσία',
      dashboard: 'Ταμπλό',
  ...
  const getRecommendedModules = () => {
    return modules
      ...
      .sort((a, b) => {
        ...
        if (experienceLevel === 'beginner' && a.difficulty === 'beginner')
          return -1;
        if (experienceLevel === 'advanced' && a.difficulty === 'advanced')
          return -1;
                      ...
                      <div className="flex items-center justify-between mb-4">
                        <div>
                          ...
                          <p className="text-blue-100">
                            Interactive Training • 60 minutes
                          </p>
                        </div>
                        <div className="text-right">
                            ...
                            <div className="flex-1">
                              ...
                              <div className="flex items-center gap-2 mt-2">
                                ...
                                >
                                  {
                                    t.difficulty[
                                      module.difficulty as keyof typeof t.difficulty
                                    ]
                                  }
                                </Badge>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      ...
                      <div className="pt-4 border-t">
                        ...
                        <div className="text-sm text-gray-600">
                          Complete 3 more modules to reach{' '}
                          <strong>Journeyman</strong> level
                        </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {learningPaths.map(path => {
                ...
                const pathModules = modules.filter(m =>
                  path.modules.includes(m.id)
                );
                const completedModules = pathModules.filter(
                  m => m.completed
                ).length;
                const completionRate =
                  (completedModules / pathModules.length) * 100;
                  ...
                  >
                    <CardHeader>
                      <div className="flex items-center gap-3 mb-3">
                        <div
                          className={`p-2 ${path.color} rounded-lg text-white`}
                        >
                          <IconComponent className="h-6 w-6" />
                        </div>
                        <div>
                          <CardTitle>
                            {locale === 'en' ? path.title : path.titleEl}
                          </CardTitle>
                          <p className="text-sm text-gray-600">
                            {locale === 'en' ? path.role : path.roleEl}
                          </p>
                        </div>
                      </div>
                    </CardHeader>
                    <CardContent>
                      ...
                      <div className="space-y-3 mb-6">
                        <div className="flex justify-between text-sm">
                          <span>
                            {t.estimatedTime}: {path.estimatedHours}h
                          </span>
                          <span>
                            {completedModules}/{pathModules.length} modules
                          </span>
                        </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {modules.map(module => {
                ...
                return (
                  <Card
                    key={module.id}
                    className={`hover:shadow-lg transition-shadow ${module.locked ? 'opacity-60' : ''}`}
                  >
                    <CardHeader>
                      ...
                      <div className="space-y-3 mb-4">
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center gap-1 text-sm text-gray-500">
                            <Star className="h-3 w-3 text-yellow-500 fill-current" />
                            {module.rating} • {module.enrolledCount}{' '}
                            {t.enrolled}
                          </div>
                        </div>
                        ...
                        <div className="flex items-center gap-4 text-sm text-gray-600">
                          ...
                          <div className="flex items-center gap-1">
                            ...
                            {
                              t.moduleTypes[
                                module.type as keyof typeof t.moduleTypes
                              ]
                            }
                          </div>
                        </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <Card className="bg-gradient-to-br from-yellow-100 to-yellow-200">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-gray-600">
                    You've completed your first training module!
                  </p>
              ...
              <Card className="bg-gradient-to-br from-green-100 to-green-200">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-gray-600">
                    Completed a module in under 30 minutes
                  </p>
              ...
              <Card className="bg-gray-100 opacity-75">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-gray-500">
                    Complete all Greek compliance modules
                  </p>
                  ...
                  <div className="space-y-4">
                    <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
                      ...
                      <p className="text-green-700 text-sm">
                        You're excelling in Greek compliance modules. Keep it
                        up!
                      </p>
                    </div>
                    ...
                    <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                      ...
                      <p className="text-yellow-700 text-sm">
                        Consider spending more time on payroll calculations for
                    ...
                    <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                      ...
                      <p className="text-blue-700 text-sm">
                        Try the interactive modules - they match your learning
                        style perfectly!
                      </p>
                    </div>
                  </div>
