      ...
      <Card>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <Badge className={getCoverageColor(coverage.coveragePercentage)}>
                {formatNumber(coverage.coveragePercentage, currentLocale, 1)}%{' '}
                {t('explanation.coverage')}
              </Badge>
              <div
                className={cn(
                  'text-sm font-medium',
              ...
              >
                {formatNumber(confidenceScore * 100, currentLocale, 0)}%{' '}
        ...
        <CardContent>
          <div className="flex items-center justify-between text-sm text-gray-600">
            <span>
              {t('explanation.generated')}:{' '}
              {formatDate(
                new Date(content.metadata.generatedAt),
                currentLocale
              )}
            </span>
            <div className="flex items-center gap-4">
              ...
              >
                ...
                {showFormulas
                  ? t('explanation.hide_formulas')
                  : t('explanation.show_formulas')}
              </Button>
              {onFeedback && (
                <Button
                  variant="outline"
          ...
          <CardContent className="pt-6">
            <div className="space-y-4">
              <h3 className="font-medium">
                {isGreek
                  ? 'Πόσο χρήσιμη ήταν αυτή η εξήγηση;'
          ...
          <div className="space-y-3">
            <div className="flex justify-between py-2">
              <span className="font-medium">
                {isGreek
                  ? content.summary.totalGrossLabelEl
                  : content.summary.totalGrossLabel}
              </span>
            ...
            <div className="flex justify-between py-2 border-t">
              <span className="font-medium">
                {isGreek
                  ? content.summary.totalDeductionsLabelEl
                  : content.summary.totalDeductionsLabel}
              </span>
            ...
            <div className="flex justify-between py-2 border-t-2 border-gray-300">
              <span className="font-bold text-lg">
                {isGreek
                  ? content.summary.netPayLabelEl
                  : content.summary.netPayLabel}
              </span>
