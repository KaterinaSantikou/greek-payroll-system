...
export async function executeAllDSTTests(
  req: Request,
  res: Response
): Promise<void> {
  try {
    const testResults = await timezoneTestService.executeAllDSTTests();
    const testReport = timezoneTestService.generateTestReport(
      testResults.results
    );
...
export async function calculateDSTAwareShift(
  req: Request,
  res: Response
): Promise<void> {
  try {
...
export async function calculateDSTAwareOvertime(
  req: Request,
  res: Response
): Promise<void> {
  try {
...
export async function getDSTTransitions(
  req: Request,
  res: Response
): Promise<void> {
  try {
...
export async function validateTimezone(
  ...
  try {
    ...
    const validation = dstTransitionService.validateTimeExists(
      targetDate,
      time,
      timezone
    );
...
export async function calculateRemoteWork(
  req: Request,
  res: Response
): Promise<void> {
  try {
    ...
    const remoteWorkCalc =
      internationalTimezoneService.calculateRemoteWorkingHours(shift);
...
export async function generateScheduleRecommendations(
  ...
  try {
    const { startTime, endTime, workDays, startDate, endDate } = req.body;
